...
description: Work toward a specified goal across repeated continuation threads. Use when the user gives a goal and asks for recursive handoffs, autonomous continuation, iterative handoffs until done, or to keep handing off after each completed slice until the goal is reached.
---
