...
- **`reorder-locals` explicit-pass signoff** by **@jtenner**. Updated [`CHANGELOG.md`](./CHANGELOG.md), [`agent-todo.md`](./agent-todo.md), [`docs/0063-2026-03-24-pass-port-batches-and-registry-map.md`](./docs/0063-2026-03-24-pass-port-batches-and-registry-map.md), [`docs/wiki/raw/research/0073-2026-04-02-reorder-locals-binaryen-comparison.md`](./docs/wiki/raw/research/0073-2026-04-02-reorder-locals-binaryen-comparison.md), [`docs/wiki/raw/research/0074-2026-04-02-binaryen-multivalue-call-local-disparity.md`](./docs/wiki/raw/research/0074-2026-04-02-binaryen-multivalue-call-local-disparity.md), [`scripts/lib/pass-fuzz-compare-task.ts`](./scripts/lib/pass-fuzz-compare-task.ts), [`scripts/lib/self-optimize-compare-task.ts`](./scripts/lib/self-optimize-compare-task.ts), [`scripts/test/pass-fuzz-compare-command.ts`](./scripts/test/pass-fuzz-compare-command.ts), [`scripts/test/self-optimize-compare-binaryen-require-converged-command.ts`](./scripts/test/self-optimize-compare-binaryen-require-converged-command.ts), [`scripts/test/self-optimize-compare-binaryen-roundtrip-command.ts`](./scripts/test/self-optimize-compare-binaryen-roundtrip-command.ts), [`scripts/test/self-optimize-compare-binaryen-stable-roundtrip-command.ts`](./scripts/test/self-optimize-compare-binaryen-stable-roundtrip-command.ts), [`scripts/test/self-optimize-compare-binaryen-unstable-roundtrip-command.ts`](./scripts/test/self-optimize-compare-binaryen-unstable-roundtrip-command.ts), [`src/cmd/cmd_test.mbt`](./src/cmd/cmd_test.mbt), [`src/passes/optimize.mbt`](./src/passes/optimize.mbt), [`src/passes/optimize_test.mbt`](./src/passes/optimize_test.mbt), [`src/passes/pass_manager.mbt`](./src/passes/pass_manager.mbt), [`src/passes/pkg.generated.mbti`](./src/passes/pkg.generated.mbti), [`src/passes/registry_test.mbt`](./src/passes/registry_test.mbt), [`src/passes/reorder_locals.mbt`](./src/passes/reorder_locals.mbt), and [`src/passes/reorder_locals_test.mbt`](./src/passes/reorder_locals_test.mbt) so `reorder-locals` now ships as an explicit module pass with focused CLI and registry coverage, documented stable-boundary compare tooling, and a measured hot-path cleanup that cut the debug-artifact runtime from `176.364 ms` into a retained `121.286-133.330 ms` band. Remaining raw emitted-wasm drift is documented as Binaryen multivalue-call writeback/materialization outside the sorter itself, so preset wiring stays deferred until the neighboring local-shape passes land.
...
- **`precompute` full-module validation checkpoint** by **@jtenner**. Updated [`CHANGELOG.md`](./CHANGELOG.md), [`agent-todo.md`](./agent-todo.md), [`docs/wiki/raw/research/0066-2026-03-24-binaryen-no-dwarf-default-optimize-path.md`](./docs/wiki/raw/research/0066-2026-03-24-binaryen-no-dwarf-default-optimize-path.md), [`src/cmd/cmd_test.mbt`](./src/cmd/cmd_test.mbt), [`src/ir/hot_module_context.mbt`](./src/ir/hot_module_context.mbt), [`src/ir/hot_module_context_test.mbt`](./src/ir/hot_module_context_test.mbt), [`src/ir/pkg.generated.mbti`](./src/ir/pkg.generated.mbti), [`src/passes/pass_manager.mbt`](./src/passes/pass_manager.mbt), [`src/passes/precompute.mbt`](./src/passes/precompute.mbt), [`src/passes/precompute_test.mbt`](./src/passes/precompute_test.mbt), [`src/validate/pkg.generated.mbti`](./src/validate/pkg.generated.mbti), and [`src/validate/validate.mbt`](./src/validate/validate.mbt) so `precompute` now folds immutable `global.get` inputs through the hot module context, validates rewritten functions against the full module environment instead of in isolation, and locks the artifact replay plus reduced repro that were previously failing closed as false `invalid function index` skips. Focused `passes` and `validate` suites are green, and the native debug-artifact `--precompute` replay now drops from `1189` traced skips to `14`, leaving only the real `stack underflow` and `invalid-escape-carrier` families as the remaining parity blockers.
...
- **`pick-load-signs` signoff** by **@jtenner**. Updated [`CHANGELOG.md`](./CHANGELOG.md), [`agent-todo.md`](./agent-todo.md), [`docs/wiki/raw/research/0069-2026-03-26-pick-load-signs.md`](./docs/wiki/raw/research/0069-2026-03-26-pick-load-signs.md), [`scripts/lib/self-optimize-compare-task.ts`](./scripts/lib/self-optimize-compare-task.ts), [`scripts/test/self-optimize-compare-command.ts`](./scripts/test/self-optimize-compare-command.ts), [`src/cmd/cmd_test.mbt`](./src/cmd/cmd_test.mbt), [`src/passes/pass_manager.mbt`](./src/passes/pass_manager.mbt), and [`src/passes/perf_test.mbt`](./src/passes/perf_test.mbt) so `self-optimize-compare` now times the latest native command via `moon run --target native --release src/cmd --` after an untimed release build warmup, and `pick-load-signs` now raw-skips functions that cannot possibly rewrite before hot lift/use-def. Native artifact replay is locked in `cmd_test`, raw-skip coverage is locked in `perf_test`, and the debug artifact compare is now green at `bun scripts/self-optimize-compare.ts tests/node/dist/starshine-debug-wasi.wasm --pick-load-signs` with exact canonical/WAT parity plus Starshine runtime `2067.184 ms` versus Binaryen `1408.509 ms`. Differential fuzz parity is also green at `.tmp/pass-fuzz-pls-genvalid-10000`, which completed `10000/10000` compared with `10000` normalized matches and `0` mismatches or failures.

## 2026-03-29 Test: complete HSO artifact signoff

- **`heap-store-optimization` artifact signoff** by **@jtenner**. Updated [`CHANGELOG.md`](./CHANGELOG.md), [`agent-todo.md`](./agent-todo.md), [`scripts/lib/self-optimize-compare-task.ts`](./scripts/lib/self-optimize-compare-task.ts), [`scripts/test/self-optimize-compare-command.ts`](./scripts/test/self-optimize-compare-command.ts), [`scripts/test/self-optimize-compare-zero-pass-command.ts`](./scripts/test/self-optimize-compare-zero-pass-command.ts), and [`src/cmd/cmd_test.mbt`](./src/cmd/cmd_test.mbt) so the self-optimize compare output now reports when Starshine intentionally raw-skips a pass, and native `cmd` coverage now replays `--heap-store-optimization` on `tests/node/dist/starshine-debug-wasi.wasm`. The checked-in debug artifact is now recorded green through `bun scripts/self-optimize-compare.ts tests/node/dist/starshine-debug-wasi.wasm --heap-store-optimization`: canonical wasm equality is exact, normalized WAT equality is exact, the raw-skip trace is explicit, and Starshine end-to-end wall time (`2119.673 ms`) remains within the project floor versus Binaryen (`1633.301 ms`).

## 2026-03-29 Fix: finish `optimize-instructions` Binaryen parity

- **`optimize-instructions` parity signoff** by **@jtenner**. Updated [`CHANGELOG.md`](./CHANGELOG.md), [`agent-todo.md`](./agent-todo.md), [`src/cmd/cmd_test.mbt`](./src/cmd/cmd_test.mbt), [`src/ir/hot_lower.mbt`](./src/ir/hot_lower.mbt), [`src/ir/hot_lower_test.mbt`](./src/ir/hot_lower_test.mbt), [`src/passes/optimize_instructions.mbt`](./src/passes/optimize_instructions.mbt), and [`src/passes/optimize_instructions_test.mbt`](./src/passes/optimize_instructions_test.mbt) so `OI` now keeps required escaping-`if` `unreachable` sentinels during lowering, preserves recursive boolean-condition rewrites behind safe use-def guards, folds constant-condition `if` wrappers to Binaryen-matching chosen arms or `nop`s, and revalidates the checked-in debug artifact replay. Verification is green with `moon test src/passes/optimize_instructions_test.mbt`, `moon test src/passes/optimize_test.mbt`, the native `cmd` debug-artifact regression, `bun scripts/pass-fuzz-compare.ts --pass optimize-instructions --generator gen-valid --count 100 --min-compared 100`, and the required `bun scripts/pass-fuzz-compare.ts --pass optimize-instructions --generator gen-valid --count 10000 --min-compared 10000`, which finished `10000/10000` compared with `10000` normalized matches and `0` mismatches.
