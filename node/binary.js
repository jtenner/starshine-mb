...
export function decodeModuleWithDetail(arg0, arg1) {
  return liftValue({ kind: "result", helper: {"isOk":"__js_result_2_is_ok","unwrapOk":"__js_result_2_unwrap_ok","unwrapErr":"__js_result_2_unwrap_err"}, ok: { kind: "tuple", helper: {"make":"__js_tuple_1_new","getters":["__js_tuple_1_get_0","__js_tuple_1_get_1"]}, items: [{ kind: "named", brand: "lib.Module", showExport: "__js_show_lib_Module" }, { kind: "number" }] }, err: { kind: "named", brand: "binary.ModuleDecodeErrorDetail", showExport: "__js_show_binary_ModuleDecodeErrorDetail" } }, wasm["binary__decode_module_with_detail"](lowerValue({ kind: "bytes", helper: {"fromArray":"__js_bytes_from_array","length":"__js_bytes_length","get":"__js_bytes_get","byteArray":{"new":"__js_array_37_new","push":"__js_array_37_push","length":"__js_array_37_length","get":"__js_array_37_get"}} }, arg0, wasm), lowerValue({ kind: "number" }, arg1, wasm)), wasm);
}

export function encodeModule(arg0) {
  return liftValue({ kind: "result", helper: {"isOk":"__js_result_3_is_ok","unwrapOk":"__js_result_3_unwrap_ok","unwrapErr":"__js_result_3_unwrap_err"}, ok: { kind: "bytes", helper: {"fromArray":"__js_bytes_from_array","length":"__js_bytes_length","get":"__js_bytes_get","byteArray":{"new":"__js_array_37_new","push":"__js_array_37_push","length":"__js_array_37_length","get":"__js_array_37_get"}} }, err: { kind: "named", brand: "binary.EncodeError", showExport: "__js_show_binary_EncodeError" } }, wasm["binary__encode_module"](lowerValue({ kind: "named", brand: "lib.Module", showExport: "__js_show_lib_Module" }, arg0, wasm)), wasm);
}

export function runBinaryRoundtripFuzz(arg0, arg1) {
  return liftValue({ kind: "result", helper: {"isOk":"__js_result_4_is_ok","unwrapOk":"__js_result_4_unwrap_ok","unwrapErr":"__js_result_4_unwrap_err"}, ok: { kind: "named", brand: "binary.BinaryRoundtripFuzzStats", showExport: "__js_show_binary_BinaryRoundtripFuzzStats" }, err: { kind: "string" } }, wasm["binary__run_binary_roundtrip_fuzz"](lowerValue({ kind: "string" }, arg0, wasm), lowerValue({ kind: "bigint" }, arg1, wasm)), wasm);
}

export function sizeSigned(arg0, arg1) {
  return liftValue({ kind: "result", helper: {"isOk":"__js_result_5_is_ok","unwrapOk":"__js_result_5_unwrap_ok","unwrapErr":"__js_result_5_unwrap_err"}, ok: { kind: "number" }, err: { kind: "named", brand: "binary.BinaryEncodeError", showExport: "__js_show_binary_BinaryEncodeError" } }, wasm["binary__size_signed"](lowerValue({ kind: "bigint" }, arg0, wasm), lowerValue({ kind: "number" }, arg1, wasm)), wasm);
}
...
export const BinaryRoundtripFuzzStats = Object.freeze({
  show(value) {
    return wasm["__js_show_binary_BinaryRoundtripFuzzStats"](value);
  },
});
