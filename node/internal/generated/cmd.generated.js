...
export function differentialValidateWasm(arg0, adapters) {
  ...
  switch (provided) {
    case 1:
      return liftValue({ kind: "result", helper: {"isOk":"__js_result_7_is_ok","unwrapOk":"__js_result_7_unwrap_ok","unwrapErr":"__js_result_7_unwrap_err"}, ok: { kind: "named", brand: "cmd.DifferentialValidationReport", showExport: "__js_show_cmd_DifferentialValidationReport" }, err: { kind: "string" } }, wasm["cmd__differential_validate_wasm__arity_1"](lowerValue({ kind: "bytes", helper: {"fromArray":"__js_bytes_from_array","length":"__js_bytes_length","get":"__js_bytes_get","byteArray":{"new":"__js_array_37_new","push":"__js_array_37_push","length":"__js_array_37_length","get":"__js_array_37_get"}} }, arg0, wasm)), wasm);
    case 2:
      return liftValue({ kind: "result", helper: {"isOk":"__js_result_7_is_ok","unwrapOk":"__js_result_7_unwrap_ok","unwrapErr":"__js_result_7_unwrap_err"}, ok: { kind: "named", brand: "cmd.DifferentialValidationReport", showExport: "__js_show_cmd_DifferentialValidationReport" }, err: { kind: "string" } }, wasm["cmd__differential_validate_wasm"](lowerValue({ kind: "bytes", helper: {"fromArray":"__js_bytes_from_array","length":"__js_bytes_length","get":"__js_bytes_get","byteArray":{"new":"__js_array_37_new","push":"__js_array_37_push","length":"__js_array_37_length","get":"__js_array_37_get"}} }, arg0, wasm), lowerValue({ kind: "named", brand: "cmd.DifferentialAdapters", showExport: null }, adapters, wasm)), wasm);
    default:
...
export function persistFuzzFailureReport(arg0, arg1, corpusDir) {
  ...
  switch (provided) {
    case 2:
      return liftValue({ kind: "result", helper: {"isOk":"__js_result_8_is_ok","unwrapOk":"__js_result_8_unwrap_ok","unwrapErr":"__js_result_8_unwrap_err"}, ok: { kind: "tuple", helper: {"make":"__js_tuple_3_new","getters":["__js_tuple_3_get_0","__js_tuple_3_get_1"]}, items: [{ kind: "string" }, { kind: "option", helper: {"none":"__js_option_2_none","some":"__js_option_2_some","isSome":"__js_option_2_is_some","unwrap":"__js_option_2_unwrap"}, item: { kind: "string" } }] }, err: { kind: "string" } }, wasm["cmd__persist_fuzz_failure_report__arity_2"](lowerValue({ kind: "named", brand: "cmd.FuzzFailureReport", showExport: "__js_show_cmd_FuzzFailureReport" }, arg0, wasm), lowerValue({ kind: "named", brand: "cmd.FuzzFailurePersistIO", showExport: null }, arg1, wasm)), wasm);
    case 3:
      return liftValue({ kind: "result", helper: {"isOk":"__js_result_8_is_ok","unwrapOk":"__js_result_8_unwrap_ok","unwrapErr":"__js_result_8_unwrap_err"}, ok: { kind: "tuple", helper: {"make":"__js_tuple_3_new","getters":["__js_tuple_3_get_0","__js_tuple_3_get_1"]}, items: [{ kind: "string" }, { kind: "option", helper: {"none":"__js_option_2_none","some":"__js_option_2_some","isSome":"__js_option_2_is_some","unwrap":"__js_option_2_unwrap"}, item: { kind: "string" } }] }, err: { kind: "string" } }, wasm["cmd__persist_fuzz_failure_report"](lowerValue({ kind: "named", brand: "cmd.FuzzFailureReport", showExport: "__js_show_cmd_FuzzFailureReport" }, arg0, wasm), lowerValue({ kind: "named", brand: "cmd.FuzzFailurePersistIO", showExport: null }, arg1, wasm), lowerValue({ kind: "string" }, corpusDir, wasm)), wasm);
    default:
...
export function runCmd(arg0) {
  return liftValue({ kind: "result", helper: {"isOk":"__js_result_9_is_ok","unwrapOk":"__js_result_9_unwrap_ok","unwrapErr":"__js_result_9_unwrap_err"}, ok: { kind: "named", brand: "cmd.CmdRunSummary", showExport: "__js_show_cmd_CmdRunSummary" }, err: { kind: "named", brand: "cmd.CmdError", showExport: "__js_show_cmd_CmdError" } }, wasm["cmd__run_cmd"](lowerValue({ kind: "array", helper: {"new":"__js_array_1_new","push":"__js_array_1_push","length":"__js_array_1_length","get":"__js_array_1_get"}, item: { kind: "string" } }, arg0, wasm)), wasm);
}
...
export function runCmdWithAdapter(arg0, arg1, configJson) {
  ...
  switch (provided) {
    case 2:
      return liftValue({ kind: "result", helper: {"isOk":"__js_result_9_is_ok","unwrapOk":"__js_result_9_unwrap_ok","unwrapErr":"__js_result_9_unwrap_err"}, ok: { kind: "named", brand: "cmd.CmdRunSummary", showExport: "__js_show_cmd_CmdRunSummary" }, err: { kind: "named", brand: "cmd.CmdError", showExport: "__js_show_cmd_CmdError" } }, wasm["cmd__run_cmd_with_adapter__arity_2"](lowerValue({ kind: "array", helper: {"new":"__js_array_1_new","push":"__js_array_1_push","length":"__js_array_1_length","get":"__js_array_1_get"}, item: { kind: "string" } }, arg0, wasm), lowerValue({ kind: "named", brand: "cmd.CmdIO", showExport: null }, arg1, wasm)), wasm);
    case 3:
      return liftValue({ kind: "result", helper: {"isOk":"__js_result_9_is_ok","unwrapOk":"__js_result_9_unwrap_ok","unwrapErr":"__js_result_9_unwrap_err"}, ok: { kind: "named", brand: "cmd.CmdRunSummary", showExport: "__js_show_cmd_CmdRunSummary" }, err: { kind: "named", brand: "cmd.CmdError", showExport: "__js_show_cmd_CmdError" } }, wasm["cmd__run_cmd_with_adapter"](lowerValue({ kind: "array", helper: {"new":"__js_array_1_new","push":"__js_array_1_push","length":"__js_array_1_length","get":"__js_array_1_get"}, item: { kind: "string" } }, arg0, wasm), lowerValue({ kind: "named", brand: "cmd.CmdIO", showExport: null }, arg1, wasm), lowerValue({ kind: "option", helper: {"none":"__js_option_2_none","some":"__js_option_2_some","isSome":"__js_option_2_is_some","unwrap":"__js_option_2_unwrap"}, item: { kind: "string" } }, configJson, wasm)), wasm);
    default:
...
export function runWasmSmithFuzzHarnessProfile(arg0, arg1) {
  return liftValue({ kind: "result", helper: {"isOk":"__js_result_10_is_ok","unwrapOk":"__js_result_10_unwrap_ok","unwrapErr":"__js_result_10_unwrap_err"}, ok: { kind: "named", brand: "cmd.WasmSmithFuzzStats", showExport: "__js_show_cmd_WasmSmithFuzzStats" }, err: { kind: "string" } }, wasm["cmd__run_wasm_smith_fuzz_harness_profile"](lowerValue({ kind: "string" }, arg0, wasm), lowerValue({ kind: "bigint" }, arg1, wasm)), wasm);
}

export function verifyReadmeApiSignatures(arg0, arg1) {
  return liftValue({ kind: "result", helper: {"isOk":"__js_result_11_is_ok","unwrapOk":"__js_result_11_unwrap_ok","unwrapErr":"__js_result_11_unwrap_err"}, ok: { kind: "unit" }, err: { kind: "string" } }, wasm["cmd__verify_readme_api_signatures"](lowerValue({ kind: "string" }, arg0, wasm), lowerValue({ kind: "array", helper: {"new":"__js_array_4_new","push":"__js_array_4_push","length":"__js_array_4_length","get":"__js_array_4_get"}, item: { kind: "tuple", helper: {"make":"__js_tuple_4_new","getters":["__js_tuple_4_get_0","__js_tuple_4_get_1"]}, items: [{ kind: "string" }, { kind: "string" }] } }, arg1, wasm)), wasm);
}

export function verifyReadmeApiSignaturesWithRequiredBlocks(arg0, arg1, arg2) {
  return liftValue({ kind: "result", helper: {"isOk":"__js_result_11_is_ok","unwrapOk":"__js_result_11_unwrap_ok","unwrapErr":"__js_result_11_unwrap_err"}, ok: { kind: "unit" }, err: { kind: "string" } }, wasm["cmd__verify_readme_api_signatures_with_required_blocks"](lowerValue({ kind: "string" }, arg0, wasm), lowerValue({ kind: "array", helper: {"new":"__js_array_4_new","push":"__js_array_4_push","length":"__js_array_4_length","get":"__js_array_4_get"}, item: { kind: "tuple", helper: {"make":"__js_tuple_4_new","getters":["__js_tuple_4_get_0","__js_tuple_4_get_1"]}, items: [{ kind: "string" }, { kind: "string" }] } }, arg1, wasm), lowerValue({ kind: "array", helper: {"new":"__js_array_1_new","push":"__js_array_1_push","length":"__js_array_1_length","get":"__js_array_1_get"}, item: { kind: "string" } }, arg2, wasm)), wasm);
}
...
export const FuzzFailureReport = Object.freeze({
  new(arg0, arg1, arg2, arg3, arg4, optimizePasses, minimizedPasses, wasm) {
    ...
    switch (provided) {
      ...
      case 8:
        return liftValue({ kind: "named", brand: "cmd.FuzzFailureReport", showExport: "__js_show_cmd_FuzzFailureReport" }, wasm["cmd__FuzzFailureReport__new"](lowerValue({ kind: "bigint" }, arg0, wasm), lowerValue({ kind: "number" }, arg1, wasm), lowerValue({ kind: "number" }, arg2, wasm), lowerValue({ kind: "string" }, arg3, wasm), lowerValue({ kind: "string" }, arg4, wasm), lowerValue({ kind: "array", helper: {"new":"__js_array_1_new","push":"__js_array_1_push","length":"__js_array_1_length","get":"__js_array_1_get"}, item: { kind: "string" } }, optimizePasses, wasm), lowerValue({ kind: "array", helper: {"new":"__js_array_1_new","push":"__js_array_1_push","length":"__js_array_1_length","get":"__js_array_1_get"}, item: { kind: "string" } }, minimizedPasses, wasm), lowerValue({ kind: "option", helper: {"none":"__js_option_8_none","some":"__js_option_8_some","isSome":"__js_option_8_is_some","unwrap":"__js_option_8_unwrap"}, item: { kind: "bytes", helper: {"fromArray":"__js_bytes_from_array","length":"__js_bytes_length","get":"__js_bytes_get","byteArray":{"new":"__js_array_37_new","push":"__js_array_37_push","length":"__js_array_37_length","get":"__js_array_37_get"}} } }, wasm, wasm)), wasm);
      default:
