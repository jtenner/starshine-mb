...
- `[DAE]014` latest source/index sync is closed as of 2026-05-25: `docs/wiki/binaryen/passes/dae-optimizing/index.md` and `starshine-strategy.md` now link research note `0576` and record the current Func505 diagnostic frontier.
