...
- [AUD]001 - Fresh Direct-Pass Mismatch Triage
  ...
  - Passes with active problems: `global-refining`, `memory-packing`, `optimize-instructions`, `precompute`, `remove-unused-brs`, `remove-unused-module-elements`, `ssa-nomerge`.
  ...
  - Current mismatch families from the audit: `global-refining` nullability/type-tightening drift, `memory-packing` data-segment normalization drift, `optimize-instructions` signed-vs-unsigned constant-fold canonicalization drift, `precompute` dead `block` / `br_table` cleanup drift, `remove-unused-brs` shared dead branch-wrapper cleanup drift, and `ssa-nomerge` temp-local shaping drift. Fresh 2026-05-06 `remove-unused-module-elements` revalidation attempt in `.tmp/pass-fuzz-remove-unused-module-elements` stopped at 2654 compared cases with 2639 normalized matches, 15 mismatches, and 5 Binaryen empty-recursion-group command failures; classify and reduce those RUME mismatches before pruning full RUME from AUD002.
...
- [AUD]002 - Revalidate Smoke-Green Direct Passes After Fuzzer Changes
  ...
  - Passes requiring full direct-pass revalidation: `remove-unused-module-elements`.
  - Completed 2026-05-06: `simplify-locals-notee-nostructure` direct revalidation in `.tmp/pass-fuzz-simplify-locals-notee-nostructure` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, 17 Binaryen empty-recursion-group parser command failures, and 3 other Binaryen/tool command failures; see `docs/wiki/raw/research/0544-2026-05-06-slnns-direct-revalidation.md`.
  - Completed 2026-05-06: `simplify-locals-nostructure` and alias `simplify-locals-no-structure` direct revalidation in `.tmp/pass-fuzz-simplify-locals-nostructure` and `.tmp/pass-fuzz-simplify-locals-no-structure` each reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0543-2026-05-06-slns-direct-revalidation.md`.
  - Completed 2026-05-06: `tuple-optimization` direct revalidation in `.tmp/pass-fuzz-tuple-optimization` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0542-2026-05-06-tuple-optimization-direct-revalidation.md`.
  - Completed 2026-05-06: `simplify-locals` direct revalidation in `.tmp/pass-fuzz-simplify-locals` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0541-2026-05-06-simplify-locals-direct-revalidation.md`.
  - Completed 2026-05-06: `reorder-locals` direct revalidation in `.tmp/pass-fuzz-reorder-locals` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0540-2026-05-06-reorder-locals-direct-revalidation.md`.
  - Completed 2026-05-06: `remove-unused-nonfunction-module-elements` direct revalidation in `.tmp/pass-fuzz-remove-unused-nonfunction-module-elements` reached 6581/10000 compared cases with 6581 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0539-2026-05-06-runfe-direct-revalidation.md`.
  - Completed 2026-05-06: `redundant-set-elimination` direct revalidation in `.tmp/pass-fuzz-redundant-set-elimination` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0538-2026-05-06-rse-direct-revalidation.md`.
  - Completed 2026-05-06: `optimize-casts` direct revalidation in `.tmp/pass-fuzz-optimize-casts` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0537-2026-05-06-optimize-casts-direct-revalidation.md`.
  - Completed 2026-05-06: `once-reduction` direct revalidation in `.tmp/pass-fuzz-once-reduction` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0536-2026-05-06-once-reduction-direct-revalidation.md`.
  - Completed 2026-05-06: `local-subtyping` direct revalidation in `.tmp/pass-fuzz-local-subtyping` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0534-2026-05-06-local-subtyping-direct-revalidation.md`.
  - Completed 2026-05-06: `merge-locals` direct revalidation in `.tmp/pass-fuzz-merge-locals` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0535-2026-05-06-merge-locals-direct-revalidation.md`.
  ...
  - Completed 2026-05-06: `duplicate-import-elimination` direct revalidation in `.tmp/pass-fuzz-duplicate-import-elimination` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0519-2026-05-06-duplicate-import-elimination-direct-revalidation.md`.
  - Completed 2026-05-06: `vacuum` direct revalidation in `.tmp/pass-fuzz-vacuum` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures after fixing empty-function single-`nop` canonicalization; see `docs/wiki/raw/research/0520-2026-05-06-vacuum-direct-revalidation.md`.
  - Completed 2026-05-06: `directize` direct revalidation in `.tmp/pass-fuzz-directize` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0521-2026-05-06-directize-direct-revalidation.md`.
  - Completed 2026-05-06: `code-folding` direct revalidation in `.tmp/pass-fuzz-code-folding` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0522-2026-05-06-code-folding-direct-revalidation.md`.
  - Completed 2026-05-06: `untee` direct revalidation in `.tmp/pass-fuzz-untee` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0523-2026-05-06-untee-direct-revalidation.md`.
  - Completed 2026-05-06: `duplicate-function-elimination` direct revalidation in `.tmp/pass-fuzz-duplicate-function-elimination` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0524-2026-05-06-duplicate-function-elimination-direct-revalidation.md`.
  - Completed 2026-05-06: `reorder-globals` direct revalidation in `.tmp/pass-fuzz-reorder-globals` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0525-2026-05-06-reorder-globals-direct-revalidation.md`.
  - Completed 2026-05-06: `string-gathering` direct revalidation in `.tmp/pass-fuzz-string-gathering` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0526-2026-05-06-string-gathering-direct-revalidation.md`.
  - Completed 2026-05-06: `code-pushing` direct revalidation in `.tmp/pass-fuzz-code-pushing` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0527-2026-05-06-code-pushing-direct-revalidation.md`.
  - Completed 2026-05-06: `dead-code-elimination` direct revalidation in `.tmp/pass-fuzz-dead-code-elimination` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0528-2026-05-06-dead-code-elimination-direct-revalidation.md`.
  - Completed 2026-05-06: `global-struct-inference` direct revalidation in `.tmp/pass-fuzz-global-struct-inference` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0529-2026-05-06-global-struct-inference-direct-revalidation.md`.
  - Completed 2026-05-06: `heap-store-optimization` direct revalidation in `.tmp/pass-fuzz-heap-store-optimization` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0530-2026-05-06-heap-store-optimization-direct-revalidation.md`.
  - Completed 2026-05-06: `heap2local` direct revalidation in `.tmp/pass-fuzz-heap2local` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0531-2026-05-06-heap2local-direct-revalidation.md`.
  - Completed 2026-05-06: `pick-load-signs` direct revalidation in `.tmp/pass-fuzz-pick-load-signs` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0532-2026-05-06-pick-load-signs-direct-revalidation.md`.
  - Completed 2026-05-06: `local-cse` direct revalidation in `.tmp/pass-fuzz-local-cse` reached 6759/10000 compared cases with 6759 normalized matches, 0 mismatches, and 20 Binaryen empty-recursion-group parser/canonicalization command failures; see `docs/wiki/raw/research/0533-2026-05-06-local-cse-direct-revalidation.md`.
