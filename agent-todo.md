...
- [O4Z-AUDIT-SSA] - Deep audit `ssa-nomerge`
  ...
  - Active `SSANM` work slices, grouped by identifier:
    ...
    - [ ] [SSANM-003a] - Implement LocalGraph straight-line no-merge writes
      ...
      - Suggested tests/evidence: red/green `ssa_nomerge_test.mbt`, `moon test src/passes`, native build, and direct `--pass ssa-nomerge` compare evidence.
