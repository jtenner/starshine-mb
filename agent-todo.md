...
- [DAE]006 - Both-Canonical Frontier Advancement
  ...
  - Next action:
    ...
    - Replace or extend the focused Moon regression to match that exact outer-block shape only after the control-flow proof is clear.
