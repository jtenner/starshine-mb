...
- The definitive fresh original-input WAGO checkpoint is now `.tmp/wago-o4z-pass8-final21-ifs-fused-sign-fresh-20260822/`, covering all 1,330 tracked fixtures at or below 2 MiB and the unchanged 766-file stable cohort with native SHA-256 `f453e39ace2e2a7da597c3dd27607829d1d3ceb989ae02cf83535bd8972b9df8`. Final21 changes exactly ifs 23,166 → **23,086** by fusing exact i32 `24; shl; 24; shr_s` and `16; shl; 16; shr_s` folding into final20’s existing branch-aware block-shell traversal; general Vacuum/final-candidate callers pass the fusion flag as false and remain output-identical. Relative to final19, the single traversal removes 461 bytes and preserves the exact event/trap sequence, 131,072-byte memory, and full-memory SHA-256 `13d4489e7d6dc9e61673dbdc74bd7f4fd5f8d69399c8ce25f6642d29e5dc842a`. Performance is neutral: +0.03% over 240 alternating pairs versus final20 and +0.19% over 240 pairs versus final19. Starshine now emits 412,836 bytes versus pinned Binaryen v131 at 415,485, a fresh 2,649-byte / 0.638% win with 110/603/53 smaller/equal/larger, 2,561 positive residual bytes, 47,294 bytes removed from the 460,130-byte baseline, and 105.93% original-gap closure. The retained projection remains distinct at 412,161 versus 415,485, a projected 3,324-byte / 0.800% win, because it retains the separately proven 22,527-byte ifs artifact. Full validation is 10,609/10,609; all passes 6,953/6,953; command 273/273. Remaining fresh leaders are ifs +973, JSON-SIMD +397, primes +378, fannkuch +169, fasta +128, scalar JSON +86, startup JSON +60, urem +38, issue1809 +35, deeply nested struct +25, bump-pointer GC +24, return-call-indirect +21 each, array-copy-inline +19, and fuzzcase 1820/1825 +8/+7. Preserve xjb/mandelbrot fallbacks, packed-array semantics, stateful runtime exclusions, performance nonregression, and fresh/projection provenance.
