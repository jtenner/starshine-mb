...
- [GSI]001 - Consume Closed-World Candidate Facts Safely
  ...
  - Why: Starshine now records immutable top-level global candidates plus direct allocation poison facts and consumes them for exact and subtype-propagated local/param origin, one-value, and two-value rewrites, and can un-nest small-module arithmetic/bitwise scalar operands, but full Binaryen-style unbounded large-module un-nesting, descriptor-cast sibling behavior, and atomic-get coverage remain deferred or blocked.
  - Deliverables:
