...
- [AUD]002 - Revalidate Smoke-Green Direct Passes After Fuzzer Changes
  ...
  - Passes requiring full direct-pass revalidation: none.
  - Completed 2026-05-06: `remove-unused-module-elements` direct revalidation in `.tmp/pass-fuzz-remove-unused-module-elements-fix2` reached 9972/10000 compared cases with 9972 normalized matches, 0 mismatches, 22 Binaryen empty-recursion-group parser command failures, 1 Binaryen bad-section-size parser failure, 2 Binaryen invalid-tag-index parser failures, and 3 Starshine missing-output command failures after fixing non-constant active-segment rooting and empty const-offset active-elem pruning; see `docs/wiki/raw/research/0545-2026-05-06-rume-direct-revalidation.md`.
