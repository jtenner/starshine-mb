...
- [O4Z-AUDIT-SSA] - Deep audit `ssa-nomerge`
  ...
  - Active `SSANM` work slices, grouped by identifier:
    ...
    - [ ] [SSANM-002b] - Shadow the LocalGraph plan against current `ssa-nomerge`
      ...
      - Suggested evidence: focused `src/passes` tests over existing reduced fixtures plus a short direct `--pass ssa-nomerge` compare probe to confirm the shadow code is observationally inert.
