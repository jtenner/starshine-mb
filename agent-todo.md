...
- [GSI]001 - Consume Closed-World Candidate Facts Safely
  ...
  - Deliverables:
    ...
    - [ ] `[GSI001-F]` Consume subtype-propagated candidate facts for safe supertype local/param one-value and two-value rewrites, including poisoned-child negatives and mixed parent/child candidate ordering coverage.
