...
- [AUD]002 - Revalidate Smoke-Green Direct Passes After Fuzzer Changes
  ...
  - Passes requiring full direct-pass revalidation: `remove-unused-module-elements`, `simplify-locals-no-structure`, `simplify-locals-nostructure`, `simplify-locals-notee-nostructure`.
