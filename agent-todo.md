...
- **Deliverables:**
  ...
  - [ ] One deterministic type edit plan covering reuse/append, typeidx controls, rec groups, exactness/nullability, abstract heaps, tags, call_ref/call_indirect, tables/elements, globals, and metadata policy. *(flattened function-type lookup/append and concrete subtype/ancestor traversal now share flattened recursive-group indexing; pruning, mixed-group edits, and complete metadata/user remapping remain open)*
