...
- [AUD]002 - Revalidate Smoke-Green Direct Passes After Fuzzer Changes
  ...
  - Passes requiring full direct-pass revalidation: `once-reduction`, `optimize-casts`, `redundant-set-elimination`, `remove-unused-module-elements`, `remove-unused-nonfunction-module-elements`, `reorder-locals`, `simplify-locals`, `simplify-locals-no-structure`, `simplify-locals-nostructure`, `simplify-locals-notee-nostructure`, `tuple-optimization`.
