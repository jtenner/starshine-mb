...
2. Do work.
   ...
   - Classify and fix the empty-active-data divergence from `.tmp/pass-fuzz-rume-rerun/failures/case-000077-wasm-smith`: determine whether Binaryen intentionally drops zero-byte active data segments during RUME or whether Starshine should preserve them and the normalized compare needs a narrower oracle.
3. Test against binaryen.
   ...
   - Replay the saved imported-element mismatch repros under `.tmp/pass-fuzz-rume-rerun/failures/case-000001-wasm-smith`, `.tmp/pass-fuzz-rume-rerun/failures/case-000005-wasm-smith`, `.tmp/pass-fuzz-rume-rerun/failures/case-000019-wasm-smith`, `.tmp/pass-fuzz-rume-rerun/failures/case-000061-wasm-smith`, and `.tmp/pass-fuzz-rume-rerun/failures/case-000097-wasm-smith`, then rerun the targeted `wasm-smith` compare harness after the imported-element fix to confirm those mismatches close without regressing the `gen-valid` sweep.
   - Reduce `.tmp/pass-fuzz-rume-rerun/failures/case-000077-wasm-smith` into a focused empty-active-data regression once the intended Binaryen parity rule is documented.
