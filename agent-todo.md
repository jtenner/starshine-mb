...
- [O4Z-AUDIT-LCSE] - Deep audit `local-cse`
  ...
  - 2026-06-05 continuation evidence: trap-sensitive scalar trunc conversion roots (`i32.trunc_f32_s`, `i64.trunc_f64_u`) and standard `ref.cast` roots are now covered as conservative documented deferrals after Binaryen spot-checks materialized representative repeats.
