...
- [O4Z-AUDIT-SSA] - Deep audit `ssa-nomerge`
  ...
  - Active `SSANM` work slices, grouped by identifier:
    ...
    - [ ] [SSANM-005b] - Preserve canonical both-arm and multi-source merges
      - Status: child-sliced on 2026-06-13; execute through `[SSANM-005b1]` through `[SSANM-005b3]` so simple no-mutation preservation, loop/backedge policy, and branch-table/full-SSA contrast stay separately reviewable.
    ...
    - [ ] [SSANM-005b3] - Classify `br`, `br_table`, and full-`ssa` contrast for multi-source merges
    ...
    - [ ] [SSANM-005c] - Freshen overwritten writes inside broader merge regions
      - Status: child-sliced on 2026-06-13; `[SSANM-005c1]` and `[SSANM-005c2]` are complete, while `[SSANM-005c3]` remains open for tee, branch-exit, and nested-control expansion.
