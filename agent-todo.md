...
- [DAE]011 - Performance Stabilization
  ...
  - Deliverables:
    ...
    - [ ] Optimize or further micro-profile the selected-def candidate loop itself, especially broad per-candidate scans inside `dae_try_remove_dropped_results(...)`, repeated undropped-call checks, and repeated caller-body rewrites over artifact-sized modules.
