...
- **Status:** **Active; `merge-blocks` and `once-reduction` renewed.** Implementation and red-first deterministic regression work are complete for `merge-blocks`, `once-reduction`, `memory-packing`, `local-subtyping`, `remove-unused-brs`, `precompute` / `precompute-propagate`, full `ssa` plan application, and the raw merge-locals cleanup. On 2026-07-26, `merge-blocks` completed its explicit post-repair v131 source and executable renewal with native SHA-256 `ae55a599bde483c6eb05347d85a1a5ef9d2c21c8b47dc100277763b82a0108ca`: regular `100000/100000`, dedicated `10000/10000`, random-all `10000/10000`, and wasm-smith `9956/9956` comparable matches with only 44 classified Binaryen-v131 tool failures. Remaining pass matrices stay open below.
