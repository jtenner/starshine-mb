...
- [RSE]002 - CFG Value Flow And Refined Local Gets
  ...
  - Tests: branch-join positives/negatives, raw block/GC-branch/loop-exit negatives, broader `rse-gc.wast`-style type-refinement tests, direct compare-pass parity, and eventual late-tail preset replay.
