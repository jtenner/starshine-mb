...
- [DAE]011 - Performance Stabilization
  ...
  - Deliverables:
    ...
    - [ ] Optimize or further micro-profile `detail:dae:core:selected-lanes:dropped-results`, especially broad call-fact collection and repeated selected-def result-removal checks.
