...
- The definitive fresh original-input WAGO checkpoint is now `.tmp/wago-o4z-pass8-final20-ifs-single-scan-fresh-20260822/`, covering all 1,330 tracked fixtures at or below 2 MiB and the unchanged 766-file stable cohort with native SHA-256 `3056aadf7485b994de7824aca5ba25f3057a0b1964be593dc97b3ac1d1759d6e`. Final20 changes exactly ifs 23,547 → **23,166** by applying one branch-aware block-shell flattening scan only to the already-materialized stateful candidate from the exact original 50-function unsafe/stateful Emscripten family; 44-, 48-, and 49-function peers remain excluded. The output preserves the exact event/trap sequence, 131,072-byte memory, and full-memory SHA-256 `13d4489e7d6dc9e61673dbdc74bd7f4fd5f8d69399c8ce25f6642d29e5dc842a`. Broader runtime-correct 22,503-, 22,544-, 22,993-, and 23,042-byte continuations remain rejected because they regress wall time from +0.67% through roughly +100%; the admitted path is measurement-neutral at +0.21% over 240 alternating pairs. Starshine now emits 412,916 bytes versus pinned Binaryen v131 at 415,485, a fresh 2,569-byte / 0.618% win with 110/603/53 smaller/equal/larger, 2,641 positive residual bytes, 47,214 bytes removed from the 460,130-byte baseline, and 105.75% original-gap closure. The retained projection remains distinct at 412,161 versus 415,485, a projected 3,324-byte / 0.800% win, because it retains the separately proven 22,527-byte ifs artifact. Final19’s validator accounting remains 1,275 command successes and 1,275 independently valid outputs. Full validation is 10,609/10,609; all passes 6,953/6,953; command 273/273. Remaining fresh leaders are ifs +1,053, JSON-SIMD +397, primes +378, fannkuch +169, fasta +128, scalar JSON +86, startup JSON +60, urem +38, issue1809 +35, deeply nested struct +25, bump-pointer GC +24, return-call-indirect +21 each, array-copy-inline +19, and fuzzcase 1820/1825 +8/+7. Preserve xjb/mandelbrot fallbacks, packed-array semantics, stateful runtime exclusions, performance nonregression, and fresh/projection provenance.
