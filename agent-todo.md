...
- [FUZ]1021 - Invalid Binary Malformed-Byte Matrix
  - Status: IN PROGRESS (cron 23, 2026-05-20). Follow-up remaining name-section UTF-8 payload slice landed: `invalid-name-section-elem-name-utf8`, `invalid-name-section-data-name-utf8`, `invalid-name-section-field-name-utf8`, and `invalid-name-section-label-name-utf8` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, custom/name-section docs, fuzz-hardening docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing name-section elem/data/field/label UTF-8 strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info`, `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as section size/count mismatch subcases, deeper memarg/alignment corruption, additional descriptor bytes, malformed/overwide LEB carriers in more contexts, more custom payload corruption, or more SIMD lane/immediate combinations without weakening stage-aware accounting. Follow-up function/element/data/tag section-size overflow slice landed: `function-section-size-overflow`, `element-section-size-overflow`, `data-section-size-overflow`, and `tag-section-size-overflow` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, LEB/fuzz-hardening docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing function/element/data/tag section-size overflow strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info`, `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as additional section-size mismatch subcases, deeper memarg/alignment corruption, additional section descriptor bytes, more malformed/overwide LEB carriers, more UTF-8/name payload corruption, or more SIMD lane/immediate combinations without weakening stage-aware accounting. Follow-up local set/tee index-LEB slice landed: `malformed-local-set-index-uleb` and `malformed-local-tee-index-uleb` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, LEB/fuzz-hardening docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing local.set/local.tee strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as more section/vector count mismatches, deeper memarg/alignment corruption, additional descriptor bytes, more malformed/overwide LEB carriers, more UTF-8/name payload corruption, or more SIMD lane/immediate combinations without weakening stage-aware accounting. Follow-up memory/global section-size overflow slice landed: `memory-section-size-overflow` and `global-section-size-overflow` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, LEB/fuzz-hardening docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing memory/global section-size overflow strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as more section/vector count mismatches, more section size mismatch subcases, deeper memarg/alignment corruption, additional descriptor bytes, more malformed/overwide LEB carriers, more UTF-8/name payload corruption, or more SIMD lane/immediate combinations without weakening stage-aware accounting. Follow-up export/table section-size overflow slice landed: `export-section-size-overflow` and `table-section-size-overflow` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, LEB/fuzz-hardening docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing export/table section-size overflow strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon info` (pre-existing DAE unused warnings only), `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as more section-size overflow subcases, deeper memarg/alignment corruption, additional descriptor bytes, more malformed/overwide LEB carriers, more UTF-8/name payload corruption, or deeper SIMD lane/immediate combinations without weakening stage-aware accounting. Follow-up section-size overflow slice landed: `type-section-size-overflow` and `import-section-size-overflow` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, LEB/fuzz-hardening docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing type/import section-size overflow strategies, then passed after implementation; the initial `code-body-size-overflow` candidate was rejected because it decoded as valid under current code-body framing behavior and was replaced rather than counted as malformed coverage. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as more section/vector count mismatches, malformed/overwide LEB carriers in more contexts, additional descriptor bytes, deeper memarg/alignment corruption, more UTF-8/name payload corruption, or more SIMD lane/immediate combinations without weakening stage-aware accounting. Follow-up memarg alignment-ULEB slice landed: `malformed-load-memarg-align-uleb` and `malformed-store-memarg-align-uleb` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, LEB/fuzz-hardening docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing load/store memarg alignment strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as section size/count mismatch subcases, additional section descriptor bytes, malformed/overwide LEB carriers in more contexts, more UTF-8/name payload corruption, or deeper SIMD lane/immediate combinations without weakening stage-aware accounting. Follow-up table/tag descriptor-byte slice landed: `invalid-table-limits-flag-byte` and `invalid-tag-attribute-byte` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing table-limits/tag-attribute strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as additional descriptor bytes, section size/count mismatch subcases, malformed/overwide LEB carriers in more contexts, more UTF-8/name payload corruption, or deeper SIMD lane/memarg combinations without weakening stage-aware accounting. Follow-up custom/name length-LEB slice landed: `malformed-custom-section-name-length-uleb` and `malformed-name-subsection-size-uleb` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing custom/name length-LEB strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as more section/vector count mismatches, additional section descriptor bytes, deeper memarg/alignment corruption, more malformed/overwide LEB carriers, more UTF-8/name payload corruption, or more SIMD lane/immediate combinations without weakening stage-aware accounting. Follow-up return/ref function-index LEB slice landed: `malformed-return-call-func-index-uleb` and `malformed-ref-func-index-uleb` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing return_call/ref.func strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as more section/vector count mismatches, additional instruction or section LEB carriers, deeper memarg/alignment corruption, additional section descriptor bytes, more UTF-8/name payload corruption, or more SIMD lane/immediate combinations without weakening stage-aware accounting. Follow-up memarg offset-ULEB slice landed: `malformed-load-memarg-offset-uleb` and `malformed-store-memarg-offset-uleb` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing memarg offset strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as deeper memarg/alignment corruption, more section/vector count mismatches, additional section descriptor bytes, more malformed/overwide LEB carriers, more UTF-8/name payload corruption, or more SIMD lane/immediate combinations without weakening stage-aware accounting. Follow-up SIMD store/replace lane-immediate overflow slice landed: `simd-store-lane-index-overflow` and `simd-replace-lane-index-overflow` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing new SIMD lane strategies (the final landed ids are store/replace), then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as section size mismatch subcases, deeper memarg/alignment corruption, additional section descriptor bytes, more malformed/overwide LEB carriers, more UTF-8/name payload corruption, or additional SIMD lane/immediate combinations without weakening stage-aware accounting. Follow-up function/element/data/tag section-size underflow slice landed: `function-section-size-underflow`, `element-section-size-underflow`, `data-section-size-underflow`, and `tag-section-size-underflow` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing function/element/data/tag size-underflow strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as more section/vector count mismatches, deeper memarg/alignment corruption, additional section descriptor bytes, more malformed/overwide LEB carriers, more UTF-8/name payload corruption, or more SIMD lane/immediate combinations without weakening stage-aware accounting. Follow-up table/memory/global section-size underflow slice landed: `table-section-size-underflow`, `memory-section-size-underflow`, and `global-section-size-underflow` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing table/memory/global size-underflow strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as additional section-size mismatch subcases, deeper memarg/alignment corruption, additional section descriptor bytes, more malformed/overwide LEB carriers, more UTF-8/name payload corruption, or more SIMD lane/immediate combinations without weakening stage-aware accounting. Follow-up import/export section-size underflow slice landed: `import-section-size-underflow` and `export-section-size-underflow` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing import/export size-underflow strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`, and `moon info` (pre-existing DAE unused warnings only). Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as additional section-size mismatch subcases, deeper memarg/alignment corruption, additional descriptor bytes, more malformed/overwide LEB carriers, more UTF-8/name payload corruption, or more SIMD lane/immediate combinations without weakening stage-aware accounting. Follow-up function/element/data/tag vector-count underflow slice landed: `function-section-count-underflow`, `element-section-count-underflow`, `data-section-count-underflow`, and `tag-section-count-underflow` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing function/element/data/tag underflow strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as section size mismatch subcases, deeper memarg/alignment corruption, additional section descriptor bytes, more malformed/overwide LEB carriers, more UTF-8/name payload corruption, or more SIMD lane/immediate combinations without weakening stage-aware accounting. Follow-up table/memory/global vector-count underflow slice landed: `table-section-count-underflow`, `memory-section-count-underflow`, and `global-section-count-underflow` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing table/memory/global underflow strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as function/element/data/tag section-count underflows, section size mismatch subcases, deeper memarg/alignment corruption, additional section descriptor bytes, more malformed/overwide LEB carriers, or more name/custom payload corruptions without weakening stage-aware accounting. Follow-up name-section memory/tag UTF-8 payload slice landed: `invalid-name-section-memory-name-utf8` and `invalid-name-section-tag-name-utf8` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` was first run after tests were added but before implementation and failed to resolve the MoonBit registry dependency until `moon update`; after implementation, the focused test passed. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as more section/vector count mismatches, section size mismatch subcases, malformed/overwide LEB carriers in more contexts, additional descriptor bytes, deeper memarg/alignment corruption, more name/custom payload corruptions, or more SIMD lane/immediate combinations without weakening stage-aware accounting. Follow-up import/export vector-count underflow slice landed: `import-section-count-underflow` and `export-section-count-underflow` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing import/export underflow strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as additional section/vector count mismatches, malformed/overwide LEB carriers in more contexts, more UTF-8/name payload corruption, additional section descriptor bytes, or deeper SIMD lane/memarg combinations without weakening stage-aware accounting. Follow-up name-section table/global UTF-8 payload slice landed: `invalid-name-section-table-name-utf8` and `invalid-name-section-global-name-utf8` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing table/global name-section UTF-8 strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as section size mismatch subcases, deeper memarg/alignment corruption, additional section descriptor bytes, more malformed/overwide LEB carriers, or more name/custom payload corruptions without weakening stage-aware accounting. Follow-up type/code size-underflow slice landed: `type-section-size-underflow` and `code-body-size-underflow` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing type/code size-underflow strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as more section/vector count mismatches, malformed/overwide LEB carriers in more contexts, more UTF-8/name payload corruption, additional section descriptor bytes, or deeper SIMD lane/memarg combinations without weakening stage-aware accounting. Follow-up type/code vector-count underflow slice landed: `type-section-count-underflow` and `code-section-count-underflow` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing type/code underflow strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as section size mismatch subcases, more malformed/overwide LEB carriers, more UTF-8/name payload corruption, additional section descriptor bytes, or deeper SIMD lane/memarg combinations without weakening stage-aware accounting. Follow-up type/code descriptor byte slice landed: `invalid-functype-byte` and `invalid-code-local-valtype-byte` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing type/code descriptor-byte strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as more section/vector count mismatches, malformed/overwide LEB carriers in more contexts, more UTF-8/name payload corruption, deeper memarg/alignment corruption, or additional section descriptor bytes without weakening stage-aware accounting. Follow-up call_indirect/br_table LEB immediate slice landed: `malformed-call-indirect-type-index-uleb` and `malformed-br-table-target-count-uleb` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing call_indirect/br_table LEB strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as more section/vector count mismatches, additional section descriptor bytes, deeper memarg/alignment corruption, more UTF-8/name payload corruption, or more malformed/overwide LEB carriers without weakening stage-aware accounting. Follow-up name-section module/type UTF-8 payload slice landed: `invalid-name-section-module-name-utf8` and `invalid-name-section-type-name-utf8` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing name-section module/type UTF-8 strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as section size mismatch subcases, deeper memarg/alignment corruption, additional section descriptor bytes, more malformed/overwide LEB carriers, or more name/custom payload corruptions without weakening stage-aware accounting. Follow-up name-section UTF-8 payload slice landed: `invalid-name-section-func-name-utf8` and `invalid-name-section-local-name-utf8` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing name-section UTF-8 strategies, then passed after implementation. Final validation for this slice ran `moon info` (pre-existing DAE unused warnings only), `moon fmt`, `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as section size mismatch subcases, deeper memarg/alignment corruption, additional section descriptor bytes, more malformed/overwide LEB carriers, or more name/custom payload corruptions without weakening stage-aware accounting. Follow-up data/element LEB instruction-immediate slice landed: `malformed-data-index-uleb` and `malformed-elem-index-uleb` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing data/element LEB strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as more section/vector count mismatches, malformed/overwide LEB carriers in more contexts, more UTF-8/name payload corruption, additional section descriptor bytes, or deeper SIMD lane/memarg combinations without weakening stage-aware accounting. Follow-up start/datacount LEB section-payload slice landed: `malformed-start-func-index-uleb` and `malformed-datacount-uleb` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing start/datacount LEB strategies, then passed after implementation. Final validation for this slice ran `moon info` (pre-existing DAE unused warnings only), `moon fmt`, `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as more UTF-8/name payload corruption, section size mismatch subcases, deeper memarg/alignment corruption, additional section descriptor bytes, or more malformed/overwide LEB carriers without weakening stage-aware accounting. Follow-up import descriptor slice landed: `invalid-import-field-name-utf8` and `invalid-import-kind-byte` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing import field-name/kind strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as more section/vector count mismatches, malformed/overwide LEB carriers in more contexts, more UTF-8/name payload corruption, additional section descriptor bytes, or deeper SIMD lane/memarg combinations without weakening stage-aware accounting. Follow-up table/select LEB immediate slice landed: `malformed-table-index-uleb` and `malformed-select-type-count-uleb` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing table/select LEB strategies, then passed after implementation. Final validation ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as more section/vector count mismatches, malformed/overwide LEB carriers in more contexts, more UTF-8/name payload corruption, additional section descriptor bytes, or deeper SIMD lane/memarg combinations without weakening stage-aware accounting. Follow-up call/branch index LEB immediate slice landed: `malformed-call-func-index-uleb` and `malformed-br-label-index-uleb` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing call/branch index strategies, then passed after implementation. Final validation for this slice ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as more section/vector count mismatches, malformed/overwide LEB carriers in more contexts, more UTF-8/name payload corruption, additional section descriptor bytes, or deeper SIMD lane/memarg combinations without weakening stage-aware accounting. Follow-up index/const LEB immediate slice landed: `malformed-global-index-uleb` and `malformed-i64-const-sleb` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing global-index/i64-const strategies, then passed after implementation. Final validation ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as more section/vector count mismatches, malformed/overwide LEB carriers in more contexts, more UTF-8/name payload corruption, additional section descriptor bytes, or deeper SIMD lane/memarg combinations without weakening stage-aware accounting. Follow-up SIMD lane-immediate slice landed: `simd-shuffle-lane-overflow` and `simd-load-lane-index-overflow` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on missing SIMD lane overflow strategies, then passed after implementation. Final validation for this slice ran `moon info` (pre-existing DAE unused warnings only), `moon fmt`, `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as more section/vector count mismatches, malformed/overwide LEB carriers in more contexts, more UTF-8/name payload corruption, additional section descriptor bytes, or deeper SIMD lane/memarg combinations without weakening stage-aware accounting. Follow-up instruction LEB immediate slice landed: `malformed-local-index-uleb` and `malformed-i32-const-sleb` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. Validation evidence for prior instruction-LEB slice: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing instruction-LEB strategies, then passed after implementation; final validation ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as more section/vector count mismatches, malformed/overwide LEB carriers in more contexts, invalid lane immediates beyond the current SIMD lane overflow case, more UTF-8/name payload corruption, or additional section descriptor bytes without weakening stage-aware accounting. Earlier slices: Narrow opcode/subopcode byte slice landed: `invalid-opcode-byte` and `invalid-prefix-subopcode-byte` are decode-rejected, non-smoke binary-invalid strategies with registry, replay, docs, and `.mbti` coverage. Follow-up memarg/blocktype byte slice landed: `malformed-memarg-immediate` and `malformed-blocktype-immediate` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. Follow-up UTF-8 payload slice landed: `invalid-export-name-utf8` and `invalid-import-module-name-utf8` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. Follow-up ref-type/heaptype byte slice landed: `invalid-table-reftype-byte` and `malformed-ref-null-heaptype-immediate` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. Follow-up global/export descriptor byte slice landed: `invalid-global-valtype-byte` and `invalid-export-kind-byte` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. Follow-up memory/global descriptor byte slice landed: `invalid-memory-limits-flag-byte` and `invalid-global-mutability-byte` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. Follow-up segment flag byte slice landed: `invalid-element-segment-flag-byte` and `invalid-data-segment-flag-byte` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. Follow-up section vector-count overflow slice landed: `type-section-count-overflow` and `code-section-count-overflow` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. Follow-up table/export vector-count overflow slice landed: `table-section-count-overflow` and `export-section-count-overflow` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. Follow-up import/global vector-count overflow slice landed: `import-section-count-overflow` and `global-section-count-overflow` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. Follow-up function/memory/element/data vector-count overflow slice landed: `function-section-count-overflow`, `memory-section-count-overflow`, `element-section-count-overflow`, and `data-section-count-overflow` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, docs, and `.mbti` coverage. Validation evidence for prior function/memory/element/data slice: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing function/memory/element/data section count-overflow strategies, then passed after implementation; final validation ran `moon fmt`, `moon info` (pre-existing DAE unused warnings only), `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than these slices; next run should continue with another malformed-byte family such as deeper section/vector count mismatches, malformed/overwide LEB carriers in more contexts, invalid lane immediates beyond the current SIMD lane overflow case, more UTF-8/name payload corruption, or additional section descriptor bytes without weakening the current stage-aware accounting. Follow-up tag section slice landed: `tag-section-count-overflow` and `malformed-tag-type-index-uleb` are decode-rejected, non-smoke binary-invalid strategies with registry, focused replay coverage, LEB docs, fuzz-hardening docs, and `.mbti` coverage. TDD evidence: `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt` failed before implementation on the missing tag section strategies, then passed after implementation. Final validation ran `moon info` (pre-existing DAE unused warnings only), `moon fmt`, `moon test --package jtenner/starshine/fuzz --file invalid_binary_wbtest.mbt`, `moon test src/fuzz`, `moon test`, and `moon run src/fuzz -- validate-invalid-binary smoke --seed 0x5eed`. Remaining blocker: the task is intentionally broader than this slice; next run should continue with another malformed-byte family such as start/datacount section immediates, more UTF-8/name payload corruption, section size mismatch subcases, deeper memarg/alignment corruption, or additional section descriptor bytes without weakening stage-aware accounting.
