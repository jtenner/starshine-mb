...
- [O4Z-AUDIT-SSA] - Deep audit `ssa-nomerge`
  ...
  - Active `SSANM` work slices, grouped by identifier:
    ...
    - [x] [SSANM-005b1] - Preserve simple both-arm and `br_if` multi-source merges
      ...
      - Remaining boundaries: plain `br`, `br_table`, loops/backedges, typed-control branch operands, EH, and mixed fresh/canonical per-write regions remain in `[SSANM-005b2]`, `[SSANM-005b3]`, `[SSANM-005c]`, `[SSANM-006a]`, and `[SSANM-007*]`.
    - [ ] [SSANM-005b2] - Classify and preserve loop/backedge canonical merges
