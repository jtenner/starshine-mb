...
- [FUZ]1006 - GenValid Call, Reference Call, Indirect Call, Recursion, And Tail-Call Widening
  - Status: IN PROGRESS (cron 23, 2026-05-21) - callable-reference local/block/global, direct-call graph, nonzero `call_indirect`, and nested direct-tail slices landed; resume remaining table/control `call_ref`, indirect tail, and broader tail-call placement widening.
