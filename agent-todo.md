...
- [DAE]006 - Both-Canonical Frontier Advancement
  ...
  - Next action:
    - Reduce one remaining Func505 live region before changing pass logic or compare tooling: loop induction/exit carrier, underscore guard polarity, or overflow/error-return construction and temp-local reuse.
