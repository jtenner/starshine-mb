...
- The current unreduced artifact frontier still starts at absolute `Func 71`, `_M0FP37jtenner9starshine3cmd31run__cmd__with__adapter_2einner` (WAT `$50`) in `/tmp/starshine-self-optimize-compare-starshine-debug-wasi-403255`. The newer raw-skip cleanup work trims more no-op families and improves sibling pass time from Starshine `2530.639ms` at `/tmp/starshine-self-optimize-compare-starshine-debug-wasi-3006682` to `2495.196ms` and `2471.758ms` in `/tmp/starshine-self-optimize-compare-starshine-debug-wasi-3020700` and `/tmp/starshine-self-optimize-compare-starshine-debug-wasi-403255`, while total wall time stays in the same noisy `4.66s` to `4.70s` band. Binaryen is still folding more nested same-arm call-result and load/store temporaries in `Func 71` than Starshine.
