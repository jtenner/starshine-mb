...
cases.push({name: "heap variant tee cast 0", pass: "heap2local", args: [0], expected: {trap: true, calls: 0, side: 0}, wat: `(module (type $base (sub (struct (field i32)))) (type $sub (sub $base (struct (field i32)))) (func (export "main") (param i32) (result i32) (local (ref null $base)) (struct.get $base 0 (ref.cast (ref $sub) (local.tee 1 (if (result (ref $base)) (local.get 0) (then (struct.new $sub (i32.const 11))) (else (struct.new $base (i32.const 22)))))))))`});
cases.push({name: "heap variant tee cast 1", pass: "heap2local", args: [1], expected: result(11), wat: `(module (type $base (sub (struct (field i32)))) (type $sub (sub $base (struct (field i32)))) (func (export "main") (param i32) (result i32) (local (ref null $base)) (struct.get $base 0 (ref.cast (ref $sub) (local.tee 1 (if (result (ref $base)) (local.get 0) (then (struct.new $sub (i32.const 11))) (else (struct.new $base (i32.const 22)))))))))`});
cases.push({name: "heap variant read cast 0", pass: "heap2local", args: [0], expected: {trap: true, calls: 0, side: 0}, wat: `(module (type $base (sub (struct (field i32)))) (type $sub (sub $base (struct (field i32)))) (func (export "main") (param i32) (result i32) (local (ref null $base)) (local.set 1 (if (result (ref $base)) (local.get 0) (then (struct.new $sub (i32.const 11))) (else (struct.new $base (i32.const 22))))) (struct.get $base 0 (ref.cast (ref $sub) (local.get 1)))))`});
cases.push({name: "heap variant read cast 1", pass: "heap2local", args: [1], expected: result(11), wat: `(module (type $base (sub (struct (field i32)))) (type $sub (sub $base (struct (field i32)))) (func (export "main") (param i32) (result i32) (local (ref null $base)) (local.set 1 (if (result (ref $base)) (local.get 0) (then (struct.new $sub (i32.const 11))) (else (struct.new $base (i32.const 22))))) (struct.get $base 0 (ref.cast (ref $sub) (local.get 1)))))`});
cases.push({name: "heap variant producer cast 0", pass: "heap2local", args: [0], expected: {trap: true, calls: 0, side: 0}, wat: `(module (type $base (sub (struct (field i32)))) (type $sub (sub $base (struct (field i32)))) (func (export "main") (param i32) (result i32) (local (ref null $base)) (local.set 1 (ref.cast (ref $sub) (if (result (ref $base)) (local.get 0) (then (struct.new $sub (i32.const 11))) (else (struct.new $base (i32.const 22)))))) (struct.get $base 0 (local.get 1))))`});
cases.push({name: "heap variant producer cast 1", pass: "heap2local", args: [1], expected: result(11), wat: `(module (type $base (sub (struct (field i32)))) (type $sub (sub $base (struct (field i32)))) (func (export "main") (param i32) (result i32) (local (ref null $base)) (local.set 1 (ref.cast (ref $sub) (if (result (ref $base)) (local.get 0) (then (struct.new $sub (i32.const 11))) (else (struct.new $base (i32.const 22)))))) (struct.get $base 0 (local.get 1))))`});
cases.push({name: "heap variant uninitialized read 0", pass: "heap2local", args: [0], expected: {trap: true, calls: 0, side: 0}, wat: `(module (type $base (sub (struct (field i32)))) (type $sub (sub $base (struct (field i32)))) (func (export "main") (param i32) (result i32) (local (ref null $base)) (drop (struct.get $base 0 (local.get 1))) (local.set 1 (if (result (ref $base)) (local.get 0) (then (struct.new $sub (i32.const 11))) (else (struct.new $base (i32.const 22))))) (struct.get $base 0 (local.get 1))))`});
cases.push({name: "heap variant uninitialized read 1", pass: "heap2local", args: [1], expected: {trap: true, calls: 0, side: 0}, wat: `(module (type $base (sub (struct (field i32)))) (type $sub (sub $base (struct (field i32)))) (func (export "main") (param i32) (result i32) (local (ref null $base)) (drop (struct.get $base 0 (local.get 1))) (local.set 1 (if (result (ref $base)) (local.get 0) (then (struct.new $sub (i32.const 11))) (else (struct.new $base (i32.const 22))))) (struct.get $base 0 (local.get 1))))`});
