...
- [`validate_invalid_ast_registry()`](../../../src/validate/invalid_fuzzer.mbt#L190-L501) is the checked-in registry of stable ids such as `duplicate-export-name`, `missing-datacount`, `undeclared-ref-func`, `invalid-func-type-index`, `datacount-mismatch-too-small`, `datacount-without-data-sec`, and function-body stack typing cases such as `invalid-function-body-table-grow-delta-type`, `invalid-function-body-table-fill-dest-type`, `invalid-function-body-table-fill-length-type`, `invalid-function-body-table-copy-length-type`, `invalid-function-body-table-copy-source-type`, `invalid-function-body-table-copy-dest-type`, `invalid-function-body-table-init-length-type`, `invalid-function-body-table-init-source-type`, `invalid-function-body-table-init-dest-type`, `invalid-function-body-data-drop-index`, `invalid-function-body-elem-drop-index`, `invalid-function-body-table-set-index-type`, `invalid-function-body-call-indirect-index-type`, `invalid-function-body-return-call-indirect-index-type`, `invalid-function-body-call-ref-type`, `invalid-function-body-return-call-ref-type`, `invalid-function-body-ref-cast-input-type`, `invalid-function-body-ref-test-input-type`, `invalid-function-body-ref-test-desc-input-type`, `invalid-function-body-ref-cast-desc-eq-input-type`, `invalid-function-body-ref-get-desc-input-type`, `invalid-function-body-ref-eq-input-type`, `invalid-function-body-array-len-input-type`, `invalid-function-body-array-get-input-type`, `invalid-function-body-array-set-input-type`, `invalid-function-body-array-set-value-type`, `invalid-function-body-array-fill-input-type`, `invalid-function-body-array-fill-value-type`, `invalid-function-body-array-fill-length-type`, `invalid-function-body-array-copy-input-type`, `invalid-function-body-array-copy-source-input-type`, `invalid-function-body-array-copy-length-type`, `invalid-function-body-array-init-data-input-type`, `invalid-function-body-array-init-data-dest-type`, `invalid-function-body-array-init-data-source-type`, `invalid-function-body-array-init-data-length-type`, `invalid-function-body-array-init-elem-input-type`, `invalid-function-body-array-init-elem-dest-type`, `invalid-function-body-array-init-elem-source-type`, `invalid-function-body-array-init-elem-length-type`, `invalid-function-body-array-new-value-type`, `invalid-function-body-array-new-length-type`, `invalid-function-body-array-new-default-length-type`, `invalid-function-body-array-new-fixed-value-type`, `invalid-function-body-array-new-data-source-type`, `invalid-function-body-array-new-data-length-type`, `invalid-function-body-array-new-elem-source-type`, `invalid-function-body-array-new-elem-length-type`, `invalid-function-body-struct-new-value-type`, `invalid-function-body-struct-get-input-type`, `invalid-function-body-struct-set-input-type`, `invalid-function-body-struct-set-value-type`, `invalid-function-body-struct-get-field-index`, `invalid-function-body-struct-set-field-index`, `invalid-function-body-struct-set-immutable-field`, `invalid-function-body-struct-get-signed-field-type`, `invalid-function-body-atomic-notify-count-type`, `invalid-function-body-atomic-wait-timeout-type`, `invalid-function-body-atomic-rmw-value-type`, `invalid-function-body-atomic-cmpxchg-replacement-type`, `invalid-function-body-atomic-load-address-type`, `invalid-function-body-atomic-store-address-type`, `invalid-function-body-atomic-store-value-type`, `invalid-function-body-br-on-cast-input-type`, and `invalid-function-body-br-on-cast-fail-input-type`.
