...
- Current `ref.func` / start boundary: [`ref-func-declarations.md`](ref-func-declarations.md). The earlier 2026-06-04 refresh is superseded for its start-membership claim.
- Current tail-call result/table64 rules: [Core validation instructions](https://webassembly.github.io/spec/core/valid/instructions.html) and [Core binary instructions](https://webassembly.github.io/spec/core/binary/instructions.html)
- Focused current-source refreshes: [`../wast/exception-tag-authoring.md`](../wast/exception-tag-authoring.md), [`memory-table-address-widths.md`](memory-table-address-widths.md), [`data-count-and-code-data-indices.md`](data-count-and-code-data-indices.md), [`constant-expressions.md`](constant-expressions.md), [`import-export-and-external-type-matching.md`](import-export-and-external-type-matching.md)
