...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass ssa --out-dir .tmp/pass-fuzz-ssa --jobs auto --starshine-bin target/native/release/build/cmd/cmd.exe
```
