...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass remove-unused-types --out-dir .tmp/pass-fuzz-remove-unused-types --jobs auto --starshine-bin target/native/release/build/cmd/cmd.exe
```
