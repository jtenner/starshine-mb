...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass pick-load-signs --out-dir .tmp/pass-fuzz-pick-load-signs --jobs auto --starshine-bin target/native/release/build/cmd/cmd.exe
```
