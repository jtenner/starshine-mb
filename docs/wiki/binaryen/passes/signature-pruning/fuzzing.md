...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass signature-pruning --out-dir .tmp/pass-fuzz-signature-pruning --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
