...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass reorder-functions --out-dir .tmp/pass-fuzz-reorder-functions --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
