...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass global-type-optimization --out-dir .tmp/pass-fuzz-global-type-optimization --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
