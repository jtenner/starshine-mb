...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass type-refining --out-dir .tmp/pass-fuzz-type-refining --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
