...
- The 2026-06-03 `[O4Z-AUDIT-GSI]` slice upgraded and signed off the direct-global subset, then moved the remaining full-Binaryen surfaces to follow-up scope; follow-ups added an analysis-only closed-world candidate/poison fact table, including subtype poison and candidate propagation, without enabling local/param rewrites yet.
