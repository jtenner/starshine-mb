...
- Current Binaryen terminology check: the Debian `wasm-opt` manpage still lists `--memory-packing`, and this maintenance run found no non-GitHub evidence of a rename or deprecation.
