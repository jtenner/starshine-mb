...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass memory-packing --out-dir .tmp/pass-fuzz-memory-packing --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
