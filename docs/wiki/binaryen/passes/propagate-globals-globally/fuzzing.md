...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass propagate-globals-globally --out-dir .tmp/pass-fuzz-propagate-globals-globally --jobs auto --starshine-bin target/native/release/build/cmd/cmd.exe
```
