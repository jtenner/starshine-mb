...
The latest post-fix regular GenValid bounded lane in [`../../../raw/research/0791-2026-06-20-precompute-true-loop-tail-reduction.md`](../../../raw/research/0791-2026-06-20-precompute-true-loop-tail-reduction.md) is `.tmp/pass-fuzz-precompute-true-loop-hot-fix-direct-100`. It compared `100/100`, normalized `16`, cleanup-normalized `64`, and still had `20` raw mismatches with no validation/generator/property/command failures. Treat those remaining mismatches as open until the constant-false loop / mixed root-debris family is reduced and either implemented, normalized with source-backed evidence, or documented with explicit closeout criteria.
