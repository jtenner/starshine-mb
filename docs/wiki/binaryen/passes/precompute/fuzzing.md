...
The post-fix regular GenValid bounded lane in [`../../../raw/research/0790-2026-06-20-precompute-self-branch-reduction.md`](../../../raw/research/0790-2026-06-20-precompute-self-branch-reduction.md) is `.tmp/pass-fuzz-precompute-self-brif-fix-direct-100`. It compared `100/100`, normalized `3`, cleanup-normalized `77`, and still had `20` raw mismatches with no validation/generator/property/command failures. Treat those remaining mismatches as open until the loop/dead-tail family is reduced and either implemented or documented with explicit closeout criteria.
