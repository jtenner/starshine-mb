...
This page is the maintenance and validation bridge for Starshine's active `precompute` pass. The July 18, 2026 closeout establishes Binaryen-v131-or-better behavior parity for the public plain and propagating variants while retaining Starshine's stricter reachable-`atomic.fence` ordering boundary.
...
The final v131 closeout is recorded in [`../../../raw/research/1574-2026-07-18-precompute-binaryen-v131-parity-reopen.md`](../../../raw/research/1574-2026-07-18-precompute-binaryen-v131-parity-reopen.md). Both public variants complete regular `100000`, dedicated `10000`, random-all `10000`, and wasm-smith `10000` request lanes. All residuals are classified Starshine correctness or canonical-size wins. Runtime/idempotence is green, self-optimization validates, plain pass-local timing is `0.191x` Binaryen, and propagation is `1.984x`, inside the maintained `2x` ceiling.
