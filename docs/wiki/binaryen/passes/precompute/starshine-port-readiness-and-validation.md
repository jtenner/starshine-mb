...
The focused Binaryen `version_130`/current-main source reconciliation in [`../../../raw/binaryen/2026-07-11-precompute-v130-current-main-reconciliation.md`](../../../raw/binaryen/2026-07-11-precompute-v130-current-main-reconciliation.md) keeps the upstream-teaching map stable while correcting the public baseline from `version_129` to `version_130`; it is not a whole-file source diff.
