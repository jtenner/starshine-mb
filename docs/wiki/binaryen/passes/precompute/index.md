...
The durable modern status refresh is [`../../../raw/research/0785-2026-06-20-precompute-modern-signoff-refresh.md`](../../../raw/research/0785-2026-06-20-precompute-modern-signoff-refresh.md). Treat the pass as active/open until the final closeout lanes are recorded; the O4z no-op boundary is decided but must stay visible as a release-boundary caveat.
