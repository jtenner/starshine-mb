...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass multi-memory-lowering --out-dir .tmp/pass-fuzz-multi-memory-lowering --jobs auto --starshine-bin target/native/release/build/cmd/cmd.exe
```
