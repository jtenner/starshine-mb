...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass remove-unused-names --out-dir .tmp/pass-fuzz-remove-unused-names --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
