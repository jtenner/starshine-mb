...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass merge-blocks --out-dir .tmp/pass-fuzz-merge-blocks --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
