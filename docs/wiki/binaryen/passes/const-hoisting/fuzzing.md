...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass const-hoisting --out-dir .tmp/pass-fuzz-const-hoisting --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
