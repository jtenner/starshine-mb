...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass type-merging --out-dir .tmp/pass-fuzz-type-merging --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
