...
The post-call-barrier regular GenValid 100000 closeout-progress lane in [`../../../raw/research/0854-2026-06-25-code-pushing-regular-100000-post-call-barrier-refresh.md`](../../../raw/research/0854-2026-06-25-code-pushing-regular-100000-post-call-barrier-refresh.md) compared `100000/100000` with `100000` normalized matches and no mismatches or failures under `--normalize local-cleanup-debris`, superseding the pre-call-barrier [`../../../raw/research/0845-2026-06-25-code-pushing-regular-100000-current.md`](../../../raw/research/0845-2026-06-25-code-pushing-regular-100000-current.md) lane. The post-call-barrier dedicated `code-pushing-all` refresh in [`../../../raw/research/0851-2026-06-25-code-pushing-all-post-call-barrier-refresh.md`](../../../raw/research/0851-2026-06-25-code-pushing-all-post-call-barrier-refresh.md) compared `10000/10000`, normalized `4769`, cleanup-normalized `5231`, and had no raw mismatches or failures with all 19 aggregate leaves sampled. The post-call-barrier explicit wasm-smith lane in [`../../../raw/research/0852-2026-06-25-code-pushing-wasm-smith-post-call-barrier-refresh.md`](../../../raw/research/0852-2026-06-25-code-pushing-wasm-smith-post-call-barrier-refresh.md) compared `9956/10000`, normalized `9956`, with no raw mismatches and `44` Binaryen/tool command failures. The post-call-barrier broad named `pass-fuzz-stress` refresh in [`../../../raw/research/0853-2026-06-25-code-pushing-pass-fuzz-stress-post-call-barrier-refresh.md`](../../../raw/research/0853-2026-06-25-code-pushing-pass-fuzz-stress-post-call-barrier-refresh.md) compared `10000/10000` with `10000` normalized matches and no failures. These satisfy current compare closeout-progress evidence as of that source state, but `[O4Z-AUDIT-CP]` remains open until remaining source gaps are resolved or narrowly accepted and the final stop condition is documented.
