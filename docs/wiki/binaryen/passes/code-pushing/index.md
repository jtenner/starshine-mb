...
- guarded movement of selected `global.get`, local-copy setup shapes, and a narrow non-null `struct.get` heap-read shape across safe intervening roots, with call, tag-based `throw`, and `try_table` roots preserved as segment-order barriers before later push points, a source-backed pure-value `throw_ref` / later-`br_if` movement refinement, and a legacy `try`/`catch` WAT fixture that currently observes Binaryen-positive movement through Starshine's try-lowered HOT block path;
...
- Unproven shapes stay unchanged; local Binaryen v130 kept a pure SFA set before an intervening call and later `br_if`, now mirrored by Starshine as a call segment barrier in [`0850`](../../../raw/research/0850-2026-06-25-code-pushing-call-barrier.md), [`0855`](../../../raw/research/0855-2026-06-25-code-pushing-throw-ref-movement.md) narrows the EH distinction by moving the same pure set after a later `br_if` when the intervening root is non-fallthrough `throw_ref`, [`0857`](../../../raw/research/0857-2026-06-25-code-pushing-plain-throw-boundary.md) records that tag-based `throw` remains stationary, [`0858`](../../../raw/research/0858-2026-06-25-code-pushing-try-table-boundary.md) records that `try_table` remains stationary, and [`0859`](../../../raw/research/0859-2026-06-25-code-pushing-legacy-try-lowered-movement.md) records that a reduced legacy `try`/`catch` probe moves after the later `br_if` in Binaryen while Starshine currently covers the observable movement through a try-lowered HOT block fixture.
...
- EH control where movement can change exceptional observability, including the current `throw_ref` positive movement, tag-based `throw` / `try_table` stationary split, and legacy `try`/`catch` try-lowered movement characterization.
...
The post-call-barrier regular GenValid 100000 closeout-progress lane in [`../../../raw/research/0854-2026-06-25-code-pushing-regular-100000-post-call-barrier-refresh.md`](../../../raw/research/0854-2026-06-25-code-pushing-regular-100000-post-call-barrier-refresh.md) compared `100000/100000` with `100000` normalized matches and no mismatches or failures under `--normalize local-cleanup-debris`, superseding the pre-call-barrier [`../../../raw/research/0845-2026-06-25-code-pushing-regular-100000-current.md`](../../../raw/research/0845-2026-06-25-code-pushing-regular-100000-current.md) lane. After the later `throw_ref` behavior refinement, the post-`throw_ref` dedicated `code-pushing-all` refresh in [`../../../raw/research/0856-2026-06-25-code-pushing-all-post-throw-ref-refresh.md`](../../../raw/research/0856-2026-06-25-code-pushing-all-post-throw-ref-refresh.md) compared `10000/10000`, normalized `4769`, cleanup-normalized `5231`, and had no raw mismatches or failures with all 19 aggregate leaves sampled, superseding the post-call-barrier [`../../../raw/research/0851-2026-06-25-code-pushing-all-post-call-barrier-refresh.md`](../../../raw/research/0851-2026-06-25-code-pushing-all-post-call-barrier-refresh.md) dedicated lane. The subsequent plain-`throw` boundary in [`../../../raw/research/0857-2026-06-25-code-pushing-plain-throw-boundary.md`](../../../raw/research/0857-2026-06-25-code-pushing-plain-throw-boundary.md) and `try_table` boundary in [`../../../raw/research/0858-2026-06-25-code-pushing-try-table-boundary.md`](../../../raw/research/0858-2026-06-25-code-pushing-try-table-boundary.md) changed behavior again to keep those EH roots stationary, so all closeout matrix lanes, including the dedicated lane, now need a post-`0858` refresh before final closeout. The post-call-barrier explicit wasm-smith lane in [`../../../raw/research/0852-2026-06-25-code-pushing-wasm-smith-post-call-barrier-refresh.md`](../../../raw/research/0852-2026-06-25-code-pushing-wasm-smith-post-call-barrier-refresh.md) compared `9956/10000`, normalized `9956`, with no raw mismatches and `44` Binaryen/tool command failures. The post-call-barrier broad named `pass-fuzz-stress` refresh in [`../../../raw/research/0853-2026-06-25-code-pushing-pass-fuzz-stress-post-call-barrier-refresh.md`](../../../raw/research/0853-2026-06-25-code-pushing-pass-fuzz-stress-post-call-barrier-refresh.md) compared `10000/10000` with `10000` normalized matches and no failures. Because [`0855`](../../../raw/research/0855-2026-06-25-code-pushing-throw-ref-movement.md) changed behavior after the post-call-barrier four-lane refresh, only the dedicated lane has been refreshed for the post-`throw_ref` source state so far; rerun the regular, wasm-smith, and broad named lanes before final closeout. `[O4Z-AUDIT-CP]` remains open until remaining source gaps are resolved or narrowly accepted and the final stop condition is documented.
