...
| `code-pushing_into_if.wast` | One-arm `if` sinking plus post-if-read, unreachable-arm subtleties, the `binaryen-intrinsics/call.without.effects` family documented as a Starshine import-metadata boundary in [`0899`](../../../raw/research/0899-2026-06-25-code-pushing-intrinsic-no-effects-boundary.md). [`0904`](../../../raw/research/0904-2026-06-25-code-pushing-import-identity-metadata.md) lands the exact function import identity prerequisite; intrinsic call movement itself remains the next behavior slice. The `ref-into-if` local-refinalization boundary remains in [`0900`](../../../raw/research/0900-2026-06-25-code-pushing-gc-ref-boundary.md). |
