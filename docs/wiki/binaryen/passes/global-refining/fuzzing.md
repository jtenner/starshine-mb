...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass global-refining --out-dir .tmp/pass-fuzz-global-refining --jobs auto --starshine-bin target/native/release/build/cmd/cmd.exe
```
