...
- Current Binaryen terminology check: the Debian `wasm-opt` manpage still lists `--global-refining`, and this maintenance run found no official-source rename or deprecation signal.
