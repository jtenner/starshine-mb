...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass de-nan --out-dir .tmp/pass-fuzz-de-nan --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
