...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass minify-imports --out-dir .tmp/pass-fuzz-minify-imports --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
