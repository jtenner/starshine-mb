...
- Official Binaryen release pages for the tracked public horizon through `version_125` are directly reachable on GitHub, and a 2026-06-02 revalidation against the direct release page, `main` changelog, and Chromium refs listing still shows `version_125` as the newest release tag visible in the mirror.
