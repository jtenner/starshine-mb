...
- The Chromium-hosted release notes visible to this maintenance run now reach Binaryen `version_129`, with directly reachable tag pages for `version_127` (`2026-03-10`), `version_128` (`2026-03-13`), and `version_129` (`2026-04-01`) in addition to the earlier `version_119` / `version_124` / `version_125` / `version_126` notes already tracked here.
