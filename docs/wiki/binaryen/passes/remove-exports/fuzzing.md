...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass remove-exports --out-dir .tmp/pass-fuzz-remove-exports --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
