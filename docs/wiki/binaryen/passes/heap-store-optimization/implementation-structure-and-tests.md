...
- [`src/passes_perf_long/heap_store_optimization_ordered_perf_test.mbt`](../../../../../src/passes_perf_long/heap_store_optimization_ordered_perf_test.mbt)
  - skipped native-release ordered-path stress coverage for long descriptor-backed fresh-struct chains, nested descriptor operands, mixed ordered memory atomics, shared-GC accesses, repeated comparison queries, and the zero per-query full-function scratch-bitset invariant.
