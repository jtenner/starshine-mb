...
- descriptor-bearing later-field result-typed `try_table` roots where another constructor field comes from the result wrapper before a same-field store fold.
