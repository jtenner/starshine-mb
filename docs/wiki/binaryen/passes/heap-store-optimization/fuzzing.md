...
- call-containing old-field expressions where an overwritten constructor field is produced by a value block containing a direct void call (not yet a true call-result old field; see `1047`);
