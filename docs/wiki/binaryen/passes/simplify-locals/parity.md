...
- The deterministic `simplify-locals-family-coverage` leaf now maps `SL-01` through `SL-35` into every aggregate, making interaction regressions reproducible alongside the larger measured-win corpus.
