...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass simplify-locals --out-dir .tmp/pass-fuzz-simplify-locals --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
