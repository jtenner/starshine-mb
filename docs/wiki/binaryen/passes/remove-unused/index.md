...
- Current Binaryen `version_129` does **not** register a pass named `remove-unused`.
- Current Binaryen `version_129` does **not** register `remove-unused-functions` either.
