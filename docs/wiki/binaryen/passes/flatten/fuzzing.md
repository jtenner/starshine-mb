...
The latest branch-index, in-place-tail, suffix-truncation, and rewrite-proof commits remain internal work only. They add no generator profile, harness allowlist entry, public pass descriptor, dispatcher, CLI execution, or compare/API exposure. Focused region editing is `4/4`, focused flatten `245/245`, private flatten `147/147`, passes `5,722/5,722`, and the full suite `9,183/9,183`, but the prior best candidate checkpoint remains `3.65x` Binaryen and the newest proof-boundary timing was noisy rather than a win. Typed EH plus structured label-owner deletion are still absent. Therefore no public compare lane is authorized yet.
