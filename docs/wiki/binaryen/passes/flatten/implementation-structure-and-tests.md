...
Validation is now focused flatten `245/245`, private flatten `146/146`, passes `5,721/5,721`, and full suite `9,181/9,181`. No `.mbti` or public pass surface changed. The same-session reconstructed candidate chain improved `1,197.5 -> 1,092.5 -> 1,030 us`; exact-shape samples remained around `1.03 ms`, about `3.9x` Binaryen, so this is measured internal performance movement rather than public-readiness evidence.
