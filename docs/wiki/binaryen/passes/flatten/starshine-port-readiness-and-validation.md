...
| Old IR2 batch plan | `docs/wiki/ir2/execution-plan.md:69-70` | `flatten` remains first in an older Batch 2 order. |
| Old registry-map plan | `docs/wiki/ir2/registry-map.md:107-108` | `flatten` remains removed until implemented. |
