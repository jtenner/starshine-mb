...
The hold point remains unchanged. Multiple or non-lane-zero rich lefts, rich payload origins combined with pre-branch left work, inputful-loop rich-left routing, typed EH, exceptional transfer, structured label-owner deletion, broader mixed/shared/nested flow, the flatten aggregate, four-lane signoff, ordered neighborhood, performance requalification, and public admission remain blocked.
