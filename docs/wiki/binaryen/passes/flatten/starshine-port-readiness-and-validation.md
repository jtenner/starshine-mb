...
The hold point is still unchanged. Rich left operands for payload-right binaries require a separate evaluation-order proof, and typed EH, exceptional transfer, structured label-owner deletion, broader mixed/shared/nested flow, the flatten aggregate, four-lane signoff, ordered neighborhood, performance requalification, and public admission remain blocked.
