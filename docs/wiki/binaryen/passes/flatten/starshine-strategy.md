...
- replace the remaining multivalue `br_if` and rich/multivalue `br_table` gates, or implement branch-targeted `if`, inputful/backedge loop or legacy-try routing, generic unreachable-placeholder, EH, or unsupported-family behavior
