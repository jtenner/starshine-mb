...
Validation reaches focused flatten `255/255`, private flatten `186/186`, passes `5,771/5,771`, full `9,232/9,232`, and green `moon info`. No `.mbti`, registry, dispatcher, CLI execution, compare/API, generator, preset, or performance surface changed. More than one rich payload, the legacy-try counterpart, multiple/non-lane-zero rich lefts, typed EH, exceptional transfer, structured label-owner deletion, broader control, signoff, neighborhood, performance, and public admission remain open.
