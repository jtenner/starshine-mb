...
- replace the remaining multivalue single-producer `br_if`/`br_table` gates, or implement remaining table-backedge loop or legacy-try routing, broader terminal-placeholder families, EH, or unsupported-family behavior
