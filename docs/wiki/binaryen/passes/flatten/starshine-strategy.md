...
- close mismatched/shared multivalue `br_if`, multi-target or mixed-target multivalue `br_table`, broader terminal-placeholder, EH-repair, and unsupported-family behavior
