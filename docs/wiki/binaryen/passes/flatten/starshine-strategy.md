...
Validation reaches focused flatten `255/255`, private flatten `186/186`, passes `5,771/5,771`, full `9,232/9,232`, and green `moon info`. No `.mbti`, registry, dispatcher, CLI execution, compare/API, generator, preset, or performance surface changed. More than one rich payload, multiple/non-lane-zero rich lefts, typed EH, exceptional transfer, structured label-owner deletion, broader control, signoff, neighborhood, performance, and public admission remain open.
...
Validation reaches focused flatten `257/257`, private flatten `186/186`, passes `5,773/5,773`, full `9,234/9,234`, and green `moon info`. No `.mbti`, registry, dispatcher, CLI execution, compare/API, generator, preset, or performance surface changed. More than one rich payload, multiple/non-lane-zero rich lefts, typed EH, exceptional transfer, structured label-owner deletion, broader mixed/shared/nested control, aggregate/signoff, ordered neighborhood, performance requalification, and public admission remain open.
