...
- close mismatched/shared multivalue `br_if`, mixed-target or nonexclusive multivalue `br_table`, broader terminal-placeholder, EH-repair, and unsupported-family behavior
