...
The key citation chain is the retained 2026-05-05 source-anchor digest in [`../../../raw/binaryen/2026-05-05-optimize-added-constants-current-main-recheck.md`](../../../raw/binaryen/2026-05-05-optimize-added-constants-current-main-recheck.md), together with the direct official Binaryen `OptimizeAddedConstants.cpp`, `pass.cpp`, `pass.h`, and plain `low-memory-unused`, memory64, and no-memory tests.
...
7. Run `moon build --target native --release src/cmd` followed by `bun fuzz compare-pass --pass optimize-added-constants ... --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe` with Binaryen configured for the low-memory assumption; do not compare ordinary no-DWARF preset output because the pass is not a default open-world blocker.
