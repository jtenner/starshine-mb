...
- Keep the 2026-07-02 GenValid profile boundary explicit: `heap2local-all` now exists for dedicated fuzzing of struct, array, and ref-fold families, but focused tests and compare lanes still need to be run before using it as signoff evidence.
