...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass strip-toolchain-annotations --out-dir .tmp/pass-fuzz-strip-toolchain-annotations --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
