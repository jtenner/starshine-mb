...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass reorder-types --out-dir .tmp/pass-fuzz-reorder-types --jobs auto --starshine-bin target/native/release/build/cmd/cmd.exe
```
