...
- [`../../../raw/research/0750-2026-06-19-optimize-instructions-oi-h-ref-func-call-ref.md`](../../../raw/research/0750-2026-06-19-optimize-instructions-oi-h-ref-func-call-ref.md) records the first `[O4Z-AUDIT-OI-H]` `call_ref` sub-slice: direct `ref.func` targets under `call_ref` and `return_call_ref` now directize to `call` and `return_call`; broader `table.get`, fallthrough-known, and select-known-target families remain open.
