...
The 2026-06-19 behavior inventory [`../../../raw/research/0726-2026-06-19-optimize-instructions-o4z-behavior-inventory.md`](../../../raw/research/0726-2026-06-19-optimize-instructions-o4z-behavior-inventory.md) keeps `[O4Z-AUDIT-OI]` open. The same-day `version_130` matrix [`../../../raw/binaryen/2026-06-19-optimize-instructions-version-130-source-refresh.md`](../../../raw/binaryen/2026-06-19-optimize-instructions-version-130-source-refresh.md) completes `[O4Z-AUDIT-OI-A]` by mapping upstream visitor and lit families to current Starshine coverage, explicit boundaries, or follow-up slice owners. The OI-B baseline [`../../../raw/research/0727-2026-06-19-optimize-instructions-oi-b-baseline.md`](../../../raw/research/0727-2026-06-19-optimize-instructions-oi-b-baseline.md) captured direct and saved O4z slot evidence: the direct 1000-case lane hit the default failure ceiling after `54/1000` compared cases with `27` raw mismatches classified as scalar/default canonicalization parity gaps and `1` Binaryen/tool command failure, while the targeted native slot16 and slot44 saved replay filters each passed `2` tests. OI-C through OI-F covered raw-gate trace accountability, default scalar parity, first sign-extension facts, and boolean/select shell cleanup. The first six OI-G slices add size-`1`/`2`/`4`/`8` `memory.copy` exact load/store lowering plus constant/local-value `memory.fill` lowering for the same selected sizes. The seventh OI-G boundary slice [`../../../raw/research/0738-2026-06-19-optimize-instructions-oi-g-memory-copy-boundaries.md`](../../../raw/research/0738-2026-06-19-optimize-instructions-oi-g-memory-copy-boundaries.md) locks zero-size, size-16, and nonconstant-size `memory.copy` as intentional fail-closed behavior until trap-mode support or overlap-safe multi-store proofs exist. The eighth and ninth OI-G memory64 slices [`../../../raw/research/0739-2026-06-19-optimize-instructions-oi-g-memory64-copy.md`](../../../raw/research/0739-2026-06-19-optimize-instructions-oi-g-memory64-copy.md) and [`../../../raw/research/0740-2026-06-19-optimize-instructions-oi-g-memory64-fill.md`](../../../raw/research/0740-2026-06-19-optimize-instructions-oi-g-memory64-fill.md) prove exact tiny copy/fill lowering on memory64 modules using direct core fixtures after the local `memory.fill` typechecker length fix. The tenth OI-G slice [`../../../raw/research/0741-2026-06-19-optimize-instructions-oi-g-narrow-store-mask.md`](../../../raw/research/0741-2026-06-19-optimize-instructions-oi-g-narrow-store-mask.md) adds a narrow `optimizeStoredValue` subset by removing redundant low-bit masks before `i32.store8` and `i32.store16` while keeping value-changing masks. The eleventh OI-G slice [`../../../raw/research/0742-2026-06-19-optimize-instructions-oi-g-i64-narrow-store-mask.md`](../../../raw/research/0742-2026-06-19-optimize-instructions-oi-g-i64-narrow-store-mask.md) extends that local stored-value cleanup to `i64.store8` / `i64.store16` / `i64.store32` as a documented Starshine-win generalization, while noting that Binaryen `version_130` keeps those exact `i64.and` masks. The twelfth OI-G slice [`../../../raw/research/0743-2026-06-19-optimize-instructions-oi-g-const-memory-offset.md`](../../../raw/research/0743-2026-06-19-optimize-instructions-oi-g-const-memory-offset.md) implements Binaryen's narrow memory32 constant-pointer static-offset fold for loads and stores, with an `INT32_MAX` boundary fixture. The remaining active backlog starts with broader load/store canonicalization, effect/trap negatives where useful, the load-call raw-gate decision, `call_ref`, reference/cast/descriptor/null-trap families, GC non-atomic and atomic rewrites, tuple extraction, and final direct/O4z closeout.
