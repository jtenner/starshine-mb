...
- definitely successful `ref.cast` / `ref.test` cases beyond the covered constructor, exact local, and `(ref i31)` local-supertype subsets plus broader failed cast/test cases beyond the local `ref.i31` miss proof
