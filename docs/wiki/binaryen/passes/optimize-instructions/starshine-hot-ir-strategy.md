...
The local HOT implementation now models seven upstream `visitCallRef(...)` known-target slices plus three superseded boundary notes and one current boundary-negative slice:
