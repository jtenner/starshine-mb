...
- narrow stored-value cleanup for redundant masks in either `and` operand order before `i32.store8` / `i32.store16` and, as a documented Starshine-win generalization, `i64.store8` / `i64.store16` / `i64.store32`
