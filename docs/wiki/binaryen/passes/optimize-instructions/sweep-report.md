...
6. `pass-oi-tuple` with randomized trigger-biased selected-lane constructors, broader existing-producer tuple wrappers, live trapping variants, and true tuple-scratch probes beyond the current seed-indexed direct/local-carried/all-result/helper-call-produced/effectful-sibling multivalue selected-lane trigger smoke plus synthetic selected-lane transform.
