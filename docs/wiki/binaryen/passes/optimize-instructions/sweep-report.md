...
6. `pass-oi-tuple` with randomized trigger-biased selected-lane constructors, broader existing-producer tuple wrappers, and live effect/trap sibling variants beyond the current seed-indexed direct/local-carried/all-result/helper-call-produced multivalue selected-lane trigger smoke plus synthetic selected-lane transform.
