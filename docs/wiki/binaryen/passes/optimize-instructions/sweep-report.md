...
than the earlier three-case trigger smoke. It emits thirty-eight OI-G
...
select-produced aligned-address same-value atomic cmpxchg restore exported function. The focused generator test
...
runtime-store8 mask restore, shared-atomic random-address xchg restore, shared-atomic random-address add-zero restore, shared-atomic random-address cmpxchg restore, shared-atomic random-address sub-zero restore, shared-atomic random-address xor-zero restore, shared-atomic random-address or-zero/and-all-ones restore, local.tee/helper-call/select-produced atomic add-zero restore, select-produced atomic xchg restore, and select-produced atomic cmpxchg restore labels/signatures before implementation; it now passes.
