...
6. `pass-oi-tuple` with randomized trigger-biased selected-lane constructors, existing-producer tuple wrappers, and effect/trap sibling variants beyond the current seed-indexed direct/local-carried/all-result multivalue selected-lane trigger smoke plus synthetic selected-lane transform.
