...
- a whole-function local prescan equivalent beyond the narrow fallthrough sign facts, direct sign-extension equality range folds, and source-backed sign-extension relational keep-spelling boundary
