...
- nested boolean-`if` normalization, `eqz` wrapping, and the narrow direct De Morgan `i32.and(i32.eqz X, i32.eqz Y)` to `i32.eqz(i32.or X Y)` cleanup
