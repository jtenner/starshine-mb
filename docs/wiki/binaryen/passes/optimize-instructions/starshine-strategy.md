...
- constant-`if` folding and constant-condition / identical-pure-arm local/global/ref.null/ref.func/ref.i31 (including a narrow `i32.add(local.get, i32.const)` payload shell)/integer/float `select` cleanup
