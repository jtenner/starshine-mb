...
- The tracked remaining Binaryen delta is now explicit and targeted rather than a broad hidden family list, so the active implementation can keep moving while EH handler flow and the two validator/tooling boundaries stay visible.
