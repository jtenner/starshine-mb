...
- `src/passes/local_subtyping.mbt:143-579`
  - heap subtype helpers, assignment collection, candidate narrowing, straight-line/branch-free block/loop/nested-if/root-if dominance scanning, branch-free block write post-state propagation, and function-local rewrite.
- `src/passes/local_subtyping.mbt:580-611`
