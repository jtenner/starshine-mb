...
Use the aggregate to guard future OC changes. Do not report OC closeout until the remaining required matrix lanes, including direct regular GenValid, explicit wasm-smith, and broad/random profiles, plus O4z slot/neighborhood evidence, pass-local timing, and final source/docs review are complete.
