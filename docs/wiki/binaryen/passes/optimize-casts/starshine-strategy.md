...
- a dedicated `optimize-casts-all` GenValid aggregate exists and is green at closeout scale, but final closeout still depends on residual acceptance/normalization decisions and final source review
