...
- a dedicated `optimize-casts-all` GenValid aggregate exists and the exact-local 100-case smoke is green, but it is intentionally not a closeout lane until the required scaled matrix and source review are complete
