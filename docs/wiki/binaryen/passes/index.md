...
- [`simplify-locals/index.md`](simplify-locals/index.md) - Folder now has a landing page plus Binaryen and Starshine strategy notes for the active simplify-locals parity work.
