...
This page maps the corrected source contract to concrete Binaryen files. The map intentionally calls out the 2026-04-24 miscorrection so future readers do not reintroduce either stale model.
