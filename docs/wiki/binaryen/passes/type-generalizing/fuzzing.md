...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass type-generalizing --out-dir .tmp/pass-fuzz-type-generalizing --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
