...
Unlike ordinary pass shape pages, these examples use **metadata shapes** rather than instruction-only WAT shapes, because the reviewed Binaryen pass clears function effect summaries instead of rewriting Wasm bodies.
