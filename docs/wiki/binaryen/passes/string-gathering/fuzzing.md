...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass string-gathering --out-dir .tmp/pass-fuzz-string-gathering --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
