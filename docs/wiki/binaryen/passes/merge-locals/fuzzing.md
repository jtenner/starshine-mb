...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass merge-locals --out-dir .tmp/pass-fuzz-merge-locals --jobs auto --starshine-bin target/native/release/build/cmd/cmd.exe
```
