...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass string-lowering --out-dir .tmp/pass-fuzz-string-lowering --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
