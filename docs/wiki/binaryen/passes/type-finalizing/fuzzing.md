...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass type-finalizing --out-dir .tmp/pass-fuzz-type-finalizing --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
