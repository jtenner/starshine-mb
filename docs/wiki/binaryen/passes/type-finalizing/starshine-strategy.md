...
| Port-batch classification | `docs/0063-2026-03-24-pass-port-batches-and-registry-map.md` | Records `type-finalizing` among boundary-only type/global/signature shaping names |
