...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass monomorphize-always --out-dir .tmp/pass-fuzz-monomorphize-always --jobs auto --starshine-bin target/native/release/build/cmd/cmd.exe
```
