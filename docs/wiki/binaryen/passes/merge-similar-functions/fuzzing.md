...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass merge-similar-functions --out-dir .tmp/pass-fuzz-merge-similar-functions --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
