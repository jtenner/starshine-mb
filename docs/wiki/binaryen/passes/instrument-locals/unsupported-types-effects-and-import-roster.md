...
This page covers the part of `instrument-locals` that is easiest to misread if you only skim the pass name. The source set is refreshed by [`index.md`](index.md) and retains [research note 0287](./index.md) as its tagged-release anchor.
