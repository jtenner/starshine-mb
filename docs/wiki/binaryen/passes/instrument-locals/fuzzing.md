...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass instrument-locals --out-dir .tmp/pass-fuzz-instrument-locals --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
