...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass optimize-added-constants-propagate --out-dir .tmp/pass-fuzz-optimize-added-constants-propagate --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
