...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass legalize-js-interface --out-dir .tmp/pass-fuzz-legalize-js-interface --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
