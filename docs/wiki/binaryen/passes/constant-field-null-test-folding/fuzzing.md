...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass constant-field-null-test-folding --out-dir .tmp/pass-fuzz-constant-field-null-test-folding --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
