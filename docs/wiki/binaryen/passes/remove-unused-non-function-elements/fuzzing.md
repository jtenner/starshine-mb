...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass remove-unused-non-function-elements --out-dir .tmp/pass-fuzz-remove-unused-non-function-elements --jobs auto --starshine-bin target/native/release/build/cmd/cmd.exe
```
