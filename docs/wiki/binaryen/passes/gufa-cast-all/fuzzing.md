...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass gufa-cast-all --out-dir .tmp/pass-fuzz-gufa-cast-all --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
