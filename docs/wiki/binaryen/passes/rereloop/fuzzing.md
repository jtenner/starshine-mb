...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass rereloop --out-dir .tmp/pass-fuzz-rereloop --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
