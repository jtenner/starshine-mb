...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass instrument-memory --out-dir .tmp/pass-fuzz-instrument-memory --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
