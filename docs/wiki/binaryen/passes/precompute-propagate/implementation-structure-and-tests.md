...
This page is the file-and-test map for the active Starshine public port. Its v130 source and test references are historical provenance; the maintained implementation and signoff map is the living dossier in [`./index.md`](./index.md) and [`./starshine-strategy.md`](./starshine-strategy.md).
