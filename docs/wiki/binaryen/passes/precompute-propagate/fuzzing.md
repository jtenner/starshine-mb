...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass precompute-propagate --out-dir .tmp/pass-fuzz-precompute-propagate --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
