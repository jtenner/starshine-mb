...
- `[O4Z-AUDIT-RUB-O]` final signoff was probed on 2026-06-19 before RUB-P but is not closed:
  ...
  - closeout now needs a fresh post-RUB-P final run before it can be claimed.
