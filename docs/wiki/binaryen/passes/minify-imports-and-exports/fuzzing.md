...
# `minify-imports-and-exports` Fuzzing Profile

Recommended smoke lane: run the ordinary mixed-generator compare-pass lane for this pass:

```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass minify-imports-and-exports --out-dir .tmp/pass-fuzz-minify-imports-and-exports --jobs auto --starshine-bin target/native/release/build/cmd/cmd.exe
```
