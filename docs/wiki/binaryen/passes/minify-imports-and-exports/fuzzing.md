...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass minify-imports-and-exports --out-dir .tmp/pass-fuzz-minify-imports-and-exports --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
