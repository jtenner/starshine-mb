...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass simplify-locals-notee --out-dir .tmp/pass-fuzz-simplify-locals-notee --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
