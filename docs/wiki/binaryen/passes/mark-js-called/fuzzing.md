...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass mark-js-called --out-dir .tmp/pass-fuzz-mark-js-called --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
