...
- The direct official current-main `RedundantSetElimination.cpp`, `pass.cpp`, `rse_all-features.wast` / expected output, and `rse-gc.wast` links cited by this dossier support the reviewed transform surface.
