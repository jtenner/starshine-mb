...
- Refreshed direct compare-pass parity at `.tmp/pass-fuzz-rse-rse002-branch-free-loops`: `6759/10000` compared, `6759` normalized matches, `0` mismatches, and `20` Binaryen/tool command failures.
