...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass code-folding --out-dir .tmp/pass-fuzz-code-folding --jobs auto --starshine-bin target/native/release/build/cmd/cmd.exe
```
