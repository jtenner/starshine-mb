...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass avoid-reinterprets --out-dir .tmp/pass-fuzz-avoid-reinterprets --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
