...
The current [`AvoidReinterprets.cpp`](https://github.com/WebAssembly/binaryen/blob/main/src/passes/AvoidReinterprets.cpp) owner supersedes the earlier freshness citation and keeps the teaching frame current.
