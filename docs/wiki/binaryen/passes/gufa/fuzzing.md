...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass gufa --out-dir .tmp/pass-fuzz-gufa --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
