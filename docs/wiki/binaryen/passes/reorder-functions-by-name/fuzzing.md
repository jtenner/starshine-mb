...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass reorder-functions-by-name --out-dir .tmp/pass-fuzz-reorder-functions-by-name --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
