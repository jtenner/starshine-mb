...
- `[INL]006`: active; one narrow nested direct-`return_call` tail-call subset is implemented, while `return_call`-inside-`try`, indirect/ref tail-call forms, multi-result typing, and label/name/annotation repair remain open.
