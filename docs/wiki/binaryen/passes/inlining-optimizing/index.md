...
- Latest `[INL]002` filtered-lane smoke evidence is `.tmp/pass-fuzz-inlining-optimizing-inl002-merge-locals-1000`: `998/1000` compared, `998` matches, `0` mismatches, `0` validation failures, and `2` ignored Binaryen/tool command failures.
