...
- Latest accepted direct evidence is validation-clean and green for optimizing over the recorded compared lanes; the latest `[INL]003` `v128.store64_lane` smoke also stays green for optimizing over `199/200` compared cases.
