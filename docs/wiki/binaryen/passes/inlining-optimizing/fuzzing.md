...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass inlining-optimizing --out-dir .tmp/pass-fuzz-inlining-optimizing --jobs auto --starshine-bin target/native/release/build/cmd/cmd.exe
```
