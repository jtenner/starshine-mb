...
- repeated parameter-passthrough binary, `select`, and memory-store wrappers as narrow shrinking-trivial heuristic subsets, including the latest `v128.store64_lane` wrapper;
