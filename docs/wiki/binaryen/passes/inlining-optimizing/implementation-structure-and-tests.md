...
- repeated parameter-passthrough binary, `select`, and scalar-store wrappers as narrow shrinking-trivial heuristic subsets, including the latest `i64.store32` wrapper;
