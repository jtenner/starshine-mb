...
- repeated parameter-passthrough binary, `select`, and memory/table operation wrappers as narrow shrinking-trivial heuristic subsets, including the latest `memory.init` wrapper;
