...
- repeated parameter-passthrough binary, `select`, and memory/table-store wrappers as narrow shrinking-trivial heuristic subsets, including the latest `memory.fill` wrapper;
