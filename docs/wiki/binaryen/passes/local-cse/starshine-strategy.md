...
- keep linear atomic operations, including store, wait/notify/fence, and cmpxchg roots, and packed shared-GC atomic accessors grouped with shared-GC atomics as documented conservative boundaries rather than adding atomic or memory GVN
