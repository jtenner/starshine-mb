...
- keep `string.const`, `ref.func`, and string new-array / encode-array roots unmaterialized unless a separate string/reference temp-local safety story is approved
