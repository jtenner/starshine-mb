...
- keep SIMD load, load-splat/load-zero, load-extend, and lane-load roots grouped with the existing SIMD pure-root deferral unless a separate vector load/memory-state model is approved
