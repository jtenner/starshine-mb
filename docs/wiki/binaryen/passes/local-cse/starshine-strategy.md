...
- keep linear atomic operations, including load/store width variants, wait/notify/fence, cmpxchg roots, and cmpxchg width variants, and packed shared-GC atomic accessors grouped with shared-GC atomics as documented conservative boundaries rather than adding atomic or memory GVN
