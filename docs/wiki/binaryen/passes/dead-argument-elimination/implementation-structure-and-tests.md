...
The former selected dropped-result fallback definitions `3566`, `3732`, and `3814` are deleted. The generic fact worklist produces byte-identical output on the direct artifact without them.

Current totals are `248/248` DAE white-box, `346/346` public DAE/DAEO, `6210/6210` pass-package, and `9688/9688` full deterministic tests.
