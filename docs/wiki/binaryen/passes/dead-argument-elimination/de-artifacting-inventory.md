...
| Early selected body cleanup | active definitions `267/268`; production schedules `233/236/237/256` removed | 2/4 | v131 preserves `233/256`, `237` was dead policy, and `236` now reaches exact oracle `i32.const 5` through generic call-free local-compaction nested cleanup |
