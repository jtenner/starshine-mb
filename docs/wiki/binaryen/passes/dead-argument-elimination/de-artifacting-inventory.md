...
| Late selected cleanup | active definitions `288, 311, 313`, plus pair-if work at `408`; schedules `298/299` removed | 2/4 | both fixtures export the target and v131 preserves their loop/inverted-if shape without a DAE boundary change; artifact remains byte-identical |
