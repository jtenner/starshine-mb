...
| Late selected cleanup | former definitions `311/313/327/408/1794` are identity-free; `323` remains | 1/5 | pair-if uses touched shape; terminal/default callers use exact changed-callee or foldable-const-if evidence and converge without local caps |
