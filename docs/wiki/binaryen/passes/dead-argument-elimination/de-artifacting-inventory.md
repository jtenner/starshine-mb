...
| Late selected cleanup | active definitions `288, 298, 299, 311, 313`, plus only pair-if/nop work at `408`; production schedules `246/287/867`, exact-literal `326/327/328/1795`, and Func408 const-local identity removed | 2/4 | original-shape one-param/one-local direct-call candidates inline single-use i32 constants generically; artifact is 60 bytes smaller and idempotent |
