...
| Broad nullable exact-literal lane | modules `>4096`, full definition range, min 8 nullable params; former first-`4096` prefix and `64` productive cap removed | 1/3 | nullable-count and module-size admission remain as phase/profitability policy | keep narrowing toward exact dependency seeds |
