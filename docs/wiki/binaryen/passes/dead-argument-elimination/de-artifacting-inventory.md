...
| Late selected cleanup | active definitions `311/313`, plus pair-if work at `408`; Func288 local-map and return-wrapper schedules removed | 2/4 | direct v131 preserves both exported Func288 fixture shapes without a DAE boundary change; artifact remains byte-identical |
