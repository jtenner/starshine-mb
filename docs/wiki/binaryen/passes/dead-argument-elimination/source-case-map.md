...
1. Retire producer-specific suffix/ref-null and remaining non-scalar phase-local mutation tails; TNH, general remove/constant, scalar unread/localization, and forwarding effect ownership are closed.
