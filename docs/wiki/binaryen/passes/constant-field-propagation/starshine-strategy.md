...
Use this page together with the retained [`2026-05-05 archived research recheck`](./index.md), which carries direct `version_129` and then-current-`main` comparison anchors.
