...
It should be read with the retained 2026-04-24 primary-source follow-up research, the current-main world-policy correction in [`MinimizeRecGroups.cpp`](https://github.com/WebAssembly/binaryen/blob/main/src/passes/MinimizeRecGroups.cpp), and the Starshine status map in [`./starshine-strategy.md`](./starshine-strategy.md).
