...
- It is currently **partially implemented** in Starshine as an active module pass, with `[DAE]003` and `[DAE]004` required before DAE completion/signoff. It remains direct-pass-only for v0.1.0 rather than part of public `optimize` / `shrink` presets.
...
- The backlog already tracks this as slice `DAE` in [`../../../../../agent-todo.md`](../../../../../agent-todo.md), with explicit work for call-graph pruning / touched-function tracking and nested `optimizeAfterInlining` replay. The active `[DAE]004` result-removal broadening now includes bounded descending large-module candidate scheduling from [`0608`](../../../raw/research/0608-2026-05-26-dae004-descending-large-candidate-scheduler.md), [`0609`](../../../raw/research/0609-2026-05-26-dae004-two-high-descending-candidates.md), [`0610`](../../../raw/research/0610-2026-05-26-dae004-three-high-descending-candidates.md), [`0611`](../../../raw/research/0611-2026-05-26-dae004-four-high-descending-candidates.md), [`0612`](../../../raw/research/0612-2026-05-26-dae004-five-high-descending-candidates.md), [`0613`](../../../raw/research/0613-2026-05-26-dae004-six-high-descending-candidates.md), [`0614`](../../../raw/research/0614-2026-05-26-dae004-seven-high-descending-candidates.md), [`0615`](../../../raw/research/0615-2026-05-26-dae004-eight-high-descending-candidates.md), the guarded narrow-band ninth step in [`0621`](../../../raw/research/0621-2026-05-26-dae004-guarded-ninth-descending-candidate.md), and the guarded narrow-band tenth step in [`0622`](../../../raw/research/0622-2026-05-26-dae004-guarded-tenth-descending-candidate.md). The scheduler now reaches ten high fact-driven candidates for the focused `4096 < defined <= 4608` band while keeping larger artifact modules at cap `8`; the handpicked selected-def fallback remains until broader artifact/fuzz evidence proves it can be removed safely.
...
- Keep it explicitly marked as **partial** until required slices `[DAE]003` and `[DAE]004` are signed off; `[DAE]002` only closes the current guarded touched scheduler boundary, and `[DAE]013` keeps preset / ordered-neighborhood integration direct-pass-only for v0.1.0 rather than claiming full Binaryen byte/shape replay.
