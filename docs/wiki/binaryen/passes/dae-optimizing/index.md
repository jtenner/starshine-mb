...
- Current behavior-gap evidence is research note [`1643`](../../../raw/research/1643-2026-07-17-daeo-func8185-i64-zero-carrier.md): optimizing-only post-finalization cleanup materializes an exact one-set/sixteen-get `i64.const 0` carrier at every read. The pure nontrapping substitution lowers Func `8185` from `2462` to the direct no-structure/vacuum endpoint `2458`; raw and canonical both improve by `4` bytes to `3203060` / `3263950`, leaving `+1494` canonical. Focused/full tests, native build, artifact validation, and convergence are green. Research note [`1644`](../../../raw/research/1644-2026-07-17-daeo-func8185-post-o0-residual.md) shows the exact downstream O0 replay is already fixed at `2458` except temporary `+1` branch/block representation changes; the remaining final-DAEO `+29` has no isolated replay owner and is source-backedly closed against speculative movement/coalescing. Fresh generated fuzz remains due in the full closeout matrix, and pre-slot public-pipeline blockers remain active.
