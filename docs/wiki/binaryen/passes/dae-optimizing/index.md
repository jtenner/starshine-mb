...
- The post-tuple direct matrix in research notes [`1568`](../../../raw/research/1568-2026-07-13-daeo-fresh-dedicated-and-regular-compare.md) and [`1569`](../../../raw/research/1569-2026-07-13-daeo-fresh-wasm-smith-and-random-all.md) was complete before the next artifact-discovered behavior fix. Research note [`1570`](../../../raw/research/1570-2026-07-13-daeo-scheduled-replay-localization-safety.md) fixes a native local-map crash and transient-signature scratch-local collision, keeps the post-fix dedicated profile green at `10000/10000`, and proves public `optimize`, public `shrink`, and synthesized `-O4z` each schedule DAEO exactly once in the late neighborhood and produce the same valid `38`-byte output as Binaryen O4z on the dedicated profile. Research notes [`1571`](../../../raw/research/1571-2026-07-13-daeo-post-scratchfloor-regular-and-wasm-smith.md) and [`1572`](../../../raw/research/1572-2026-07-13-daeo-post-scratchfloor-random-all.md) complete the post-fix direct matrix: regular GenValid is `100000/100000` normalized, explicit wasm-smith has `9955` normalized plus `1` cleanup-normalized out of `9956` comparable cases with only `44` Binaryen/oracle failures, and random-all has `9633` normalized plus `367` byte-identical measured/source-backed Starshine-win cleanup residuals with zero failures. The current stripped wasm-gc artifact meets the pass-local ratio target (`9692.498ms` Starshine versus `8083.49ms` Binaryen) and no longer crashes, but Starshine final validation still rejects its structured nondefaultable GC body-local initialization surface.
