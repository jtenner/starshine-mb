...
- Current behavior-gap evidence is research note [`1640`](../../../raw/research/1640-2026-07-17-daeo-func8186-final-return.md): selected structural cleanup now removes only an explicit top-level final `return`, preserving nested and nonfinal return control. Func `8186` falls from canonical body `11` to Binaryen-exact `10`; the valid byte-identical endpoint is raw `3203082` / canonical `3263972`, `+1516` over Binaryen v130. Focused/full tests, native build, artifact validation/convergence, and dedicated/regular `1000`-case normalized smokes are green. Func `8184 +16` is the next small direct owner; Func `8185 +35`, full closeout, and pre-slot public-pipeline blockers remain active.
