...
Notes [`1588`](../../../raw/research/1588-2026-07-13-daeo-two-chain-bounded-closeout.md) and [`1589`](../../../raw/research/1589-2026-07-13-daeo-converged-chain-cleanup.md) supersede the single-payoff hold point. DAEO now completes the two currently attributed broad payoff chains in one bounded invocation and includes productive Func `41` in the exact-parameter selected cleanup set. Note [`1590`](../../../raw/research/1590-2026-07-13-daeo-two-chain-final-matrix.md) records the current deterministic valid endpoint, raw `3198681` / canonical `3276084`, pass-local `9350.478ms` versus Binaryen `8083.49ms`, and the complete four-lane matrix. Dedicated and regular lanes normalize fully; wasm-smith has `9955` normalized plus `1` cleanup-normalized match and only `44` Binaryen/oracle failures; random-all completes `10000/10000` with `9633` normalized and the same `367` byte-identical measured/source-backed cleanup wins. Full tests `8807/8807`, full CI-profile validation, exact-once dedicated scheduling, and `.mbti` review are green. Readiness remains open because the direct artifact is still `+13628` canonical and large optimize/shrink/O4z remain blocked before DAEO in vacuum or ssa-nomerge.
