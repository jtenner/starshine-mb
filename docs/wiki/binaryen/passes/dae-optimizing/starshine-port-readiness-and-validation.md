...
- attribution and closure of the valid current artifact's `+16350` canonical-byte size-losing gap, including the `large-touched-set touched=23` nested-cleanup guard;
