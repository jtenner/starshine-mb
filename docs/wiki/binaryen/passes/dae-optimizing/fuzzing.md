...
Research note [`1593`](../../../raw/research/1593-2026-07-13-daeo-adjacent-chain-final-matrix.md) is the current matrix after notes [`1591`](../../../raw/research/1591-2026-07-13-daeo-adjacent-constructor-chain-cleanup.md) and [`1592`](../../../raw/research/1592-2026-07-13-daeo-adjacent-candidate-prefilter.md). With explicit native SHA-256 `9852421b3bd3d1d99ba0ffc790c2697a42af16558c4bb3b08e9d1f93d17a5516` and both DAE normalizers: dedicated is `10000/10000` normalized; regular is `100000/100000` normalized; wasm-smith is `9955` normalized plus `1` cleanup-normalized out of `9956` comparable cases with only the unchanged `44` Binaryen/oracle failures; random-all completes `10000/10000` with `9633` normalized and `367` mismatches. Random-all used `--no-reduce-mismatches`; its failure-directory names and all `2569` current semantic artifact files are byte-identical to the note `1590` lane, preserving the `coverage-forced-portable=243` / `dae-effectful-args=124` measured/source-backed Starshine cleanup-win classification and aggregate `-110219` raw / `-797486` canonical / `-5465849` WAT deltas. There are no unknown/risky, size-losing generated, Starshine validation, or true-semantic residuals. Dedicated optimize/shrink/O4z execute DAEO exactly once immediately before `inlining-optimizing`. The direct matrix is current; DAEO remains open for the `+13245` canonical artifact gap and pre-slot large scheduled blockers.
