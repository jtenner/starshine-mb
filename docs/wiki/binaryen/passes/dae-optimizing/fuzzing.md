...
Research note [`1596`](../../../raw/research/1596-2026-07-13-daeo-func41-local-compaction-final-matrix.md) is current after the generic removed-parameter local compaction and direct prefilter in notes [`1594`](../../../raw/research/1594-2026-07-13-daeo-broad-removed-param-local-compaction.md) and [`1595`](../../../raw/research/1595-2026-07-13-daeo-removed-param-direct-prefilter.md). With explicit native SHA-256 `648217241b157b7144a7e2d1b023688f5a78b52f8d0d7fec5358c28394bc08ac`, Binaryen v130, and both DAE normalizers: dedicated is `10000/10000` normalized; regular is `100000/100000` normalized; wasm-smith is `9955` normalized plus `1` cleanup-normalized out of `9956` comparable cases with only the unchanged `44` Binaryen/oracle failures; random-all completes `10000/10000` with `9633` normalized and `367` mismatches under `--no-reduce-mismatches`. Its failure-directory names and all `2936` `.wasm`/`.wat` semantic artifacts are byte-identical to note `1593`, preserving the `coverage-forced-portable=243` / `dae-effectful-args=124` measured/source-backed Starshine cleanup-win classification and aggregate `-110219` raw / `-797486` canonical / `-5465849` WAT deltas. There are no unknown/risky, size-losing generated, Starshine validation, or true-semantic residuals. Public optimize, shrink, and `--optimize -O4z` execute DAEO exactly once immediately before `inlining-optimizing`. DAEO remains open for the `+12571` canonical artifact gap and pre-slot large scheduled blockers.
