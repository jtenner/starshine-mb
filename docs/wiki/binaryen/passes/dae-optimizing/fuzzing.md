...
Research note [`1599`](../../../raw/research/1599-2026-07-14-daeo-adjacent-local-order-final-matrix.md) is the historical adjacent-pair matrix. Research note [`1602`](../../../raw/research/1602-2026-07-14-daeo-payoff-local-order-final-matrix.md) is current after notes [`1600`](../../../raw/research/1600-2026-07-14-daeo-payoff-type-stable-local-order.md) and [`1601`](../../../raw/research/1601-2026-07-14-daeo-payoff-local-order-single-scan.md) applied the same type-stable rewrite to the already selected payoff callees and removed duplicate local-reference traversal without changing output. With explicit native SHA-256 `b27d010fcd0e98034e3f1c4adef4592028c06508823f2818dc0240dd7a12b142`, Binaryen v130, and both DAE normalizers: dedicated is `10000/10000` normalized; regular is `100000/100000` normalized; wasm-smith is `9955` normalized plus `1` cleanup-normalized out of `9956` comparable cases with only the unchanged `44` Binaryen/oracle failures; random-all completes `10000/10000` with `9633` normalized and `367` mismatches under `--no-reduce-mismatches`. Its failure-directory names and all `2936` semantic `.wasm`/`.wat` artifacts are byte-identical to the prior measured set, preserving the `coverage-forced-portable=243` / `dae-effectful-args=124` measured/source-backed Starshine cleanup-win classification and aggregate `-110219` raw / `-797486` canonical / `-5465849` WAT deltas. There are no unknown/risky, size-losing generated, Starshine validation, or true-semantic residuals. Public optimize, shrink, and `--optimize -O4z` execute DAEO exactly once immediately before `inlining-optimizing`. DAEO remains open for the `+12421` canonical artifact gap and pre-slot large scheduled blockers.
