...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass inline-main --out-dir .tmp/pass-fuzz-inline-main --jobs auto --starshine-bin _build/native/release/build/cmd/cmd.exe
```
