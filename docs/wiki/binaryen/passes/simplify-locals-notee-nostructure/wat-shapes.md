...
For provenance and the direct-vs-inferred test distinction, pair the retained 2026-04-25 source bridge with [`./implementation-structure-and-tests.md`](./implementation-structure-and-tests.md).
