...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass reorder-globals --out-dir .tmp/pass-fuzz-reorder-globals --jobs auto --starshine-bin target/native/release/build/cmd/cmd.exe
```
