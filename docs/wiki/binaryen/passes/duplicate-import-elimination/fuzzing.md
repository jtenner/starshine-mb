...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass duplicate-import-elimination --out-dir .tmp/pass-fuzz-duplicate-import-elimination --jobs auto --starshine-bin target/native/release/build/cmd/cmd.exe
```
