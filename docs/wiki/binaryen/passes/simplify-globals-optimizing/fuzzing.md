...
```sh
bun scripts/pass-fuzz-compare.ts --count 10000 --seed 0x5eed --pass simplify-globals-optimizing --out-dir .tmp/pass-fuzz-simplify-globals-optimizing --jobs auto --starshine-bin target/native/release/build/cmd/cmd.exe
```
