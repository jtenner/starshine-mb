...
3. **Complete dead or redundant write repair**
   ...
   - extend the landed simple pure-condition bridge only with focused source-backed non-trapping operators; the current bitwise bridge covers `i32.and` / `i32.or` / `i32.xor`;
