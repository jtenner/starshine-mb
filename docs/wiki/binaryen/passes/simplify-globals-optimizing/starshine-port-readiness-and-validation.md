...
- current scheduler guards: at-or-below threshold runs cleanup, above threshold skips cleanup, large modules skip cleanup, and large touched functions skip cleanup.
