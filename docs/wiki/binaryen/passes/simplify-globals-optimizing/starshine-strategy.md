...
- single-const private global write propagation along straight-line and adjacent plain-block runtime traces with call/control/early-exit barriers,
...
- broader runtime linear-trace propagation beyond the landed straight-line and adjacent plain-block single-const write facts,
