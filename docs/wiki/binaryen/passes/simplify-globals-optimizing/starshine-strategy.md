...
- broader same-as-init expression matching beyond the landed direct literal/ref-null/ref.func write shape and the probed defined-`global.get`-init repeated-run boundary,
