...
- single-const private global write propagation along straight-line, adjacent plain-block, and nested plain-block runtime traces with call/control/early-exit barriers,
