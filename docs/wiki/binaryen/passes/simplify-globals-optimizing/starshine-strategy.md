...
- supported single-instruction constant `global.get` replacement in function bodies, including typed `ref.null` / direct, alias, and block-result `ref.func` cases that the pipeline validates after replacement,
