...
- [`validate/fuzz-hardening.md`](validate/fuzz-hardening.md) - Current validator fuzz surface truth, remaining hardening gaps, and the staged order for config, generator breadth, invalid lanes, and repro ergonomics.
