...
- [`binaryen/passes/code-pushing/artifact-frontiers.md`](binaryen/passes/code-pushing/artifact-frontiers.md) - Frontier ledger for the major debug-artifact mismatch families, including the reopened `Func 1977` alias-tail surface and the remaining whole-artifact/runtime gap.
...
- [`binaryen/passes/code-pushing/parity.md`](binaryen/passes/code-pushing/parity.md) - Current direct-pass parity state for `code-pushing`, including the Binaryen no-op finding on printed `func $127`, the restored `Func 148` fence, the reopened `Func 1977` alias-tail surface, and the remaining artifact/runtime signoff work.
...
- [`raw/research/0086-2026-04-13-code-pushing-standalone-func1977-leaf-suspicious-pairs.md`](raw/research/0086-2026-04-13-code-pushing-standalone-func1977-leaf-suspicious-pairs.md) - Recursive suspicious-carrier walk of standalone `Func 1977`, showing that the lower/writeback frontier bottoms out at two mirrored leaf wrapper pairs in the earlier tag-`76` / tag-`77` decode ladders, not near the final reopened local-`45` tail.
- [`raw/research/0087-2026-04-13-code-pushing-standalone-func1977-hot-lower-recursive-fix.md`](raw/research/0087-2026-04-13-code-pushing-standalone-func1977-hot-lower-recursive-fix.md) - Closing note for the reduced standalone `Func 1977` writeback frontier: newly synthesized voidified split `local.set` wrapper pairs now get recursively re-run through the mixed-depth split-wrapper repair, so the stale mirrored decode-ladder branch depth no longer underflows validation.
- [`raw/research/0088-2026-04-13-code-pushing-nonvoid-prefix-block-relaxation.md`](raw/research/0088-2026-04-13-code-pushing-nonvoid-prefix-block-relaxation.md) - Candidate-aware non-void explicit-exit block-prefix relaxation showing that earlier unsafe block prefixes are not blanket blockers for later motion, while the real same-source alias-condition-set carrier family stays fenced.
- [`raw/research/0089-2026-04-13-code-pushing-standalone-drift-canonicalization-noise.md`](raw/research/0089-2026-04-13-code-pushing-standalone-drift-canonicalization-noise.md) - Refresh note showing that standalone `Func 1948` / `Func 1977` now match Binaryen on the reopened moved-local families, so the remaining exact WAT drift is mostly inherited no-pass noise in `Func 1948` and writeback canonicalization noise in `Func 1977`.
