...
- [`binaryen/passes/optimize-instructions/index.md`](binaryen/passes/optimize-instructions/index.md) - Active hot-pass landing page; now records the fully retired slot-16 `Func 652` / `Func 1818` HOT-lower bugs and the remaining later slot-44 blocker.
