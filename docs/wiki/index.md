...
- [`binaryen/passes/simplify-locals/index.md`](binaryen/passes/simplify-locals/index.md) - Hub page for simplify-locals overview plus the current Binaryen and Starshine strategy notes.
