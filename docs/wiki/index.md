...
- [`binaryen/passes/remove-unused-brs/parity.md`](binaryen/passes/remove-unused-brs/parity.md) - Current Binaryen phase model, in-tree coverage, the fixed carried-wrapper `br_table` slice, and the remaining final-shape plus later loop/body-order gaps for `remove-unused-brs`.
