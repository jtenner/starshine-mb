...
Fresh artifact evidence uses native SHA-256 `c5c700e6d35ed958c53c3ea2efc032f31006bf4320b16bcf97a238d02a268575` and rebuilt self SHA-256 `59651c0d71f25b72f40f222a72be3ed4ec517a4b93af49899422dab4dcd1b0d1` at 4,878,770 bytes. `json-as` optimization/validation and exact runtime are `105/105`; `self-opt-smoke` passes; the exact WAGO manifest is `48/48` native optimization, `48/48` self optimization, `48/48` validation per variant, `48/48` byte identity, and `323/323` matching calls per variant. A post-repair full 842-input rerun remains deferred until the next repair group.

Evidence is preserved under `.tmp/wago-o4z-native-semantic-20260825/`, `.tmp/wago-o4z-native-semantic-core-replay4-20260825/`, `.tmp/wago-o4z-corruption-audit-20260825/`, `.tmp/wago-o4z-functional-20260825-corruption-repairs/`, `.tmp/wago-rust-fannkuch-audit-20260825/`, `.tmp/json-as-smoke-rust-fannkuch-20260825/`, and `.tmp/wago-o4z-functional-20260825-rust-fannkuch/`.
