...
| `binary-roundtrip` | Binary decode/encode stability coverage, including the ordinary arbitrary-value matrix, explicit GenValid full-module encode/decode/validate profiles, and byte-fuzz corruption profiles over generated valid binary modules. |
