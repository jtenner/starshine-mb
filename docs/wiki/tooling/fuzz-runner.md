...
| `binary-roundtrip` | Binary decode/encode stability coverage, including the ordinary arbitrary-value matrix and explicit GenValid full-module encode/decode/validate profiles. |
