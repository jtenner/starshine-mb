...
12. **Secondary Binaryen runtime execution:** `--runtime-execution node` retains the older Starshine-vs-Binaryen export matrix as separate smoke evidence.
