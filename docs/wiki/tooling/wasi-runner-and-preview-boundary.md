...
This boundary is grounded in the official [Node `node:wasi` API](https://nodejs.org/api/wasi.html), the [WebAssembly/WASI repository](https://github.com/WebAssembly/WASI), the [WASI roadmap](https://wasi.dev/roadmap), Component Model documentation, the Preview 1 WITX source, and current Starshine runner/build/test evidence.
...
- Upstream Preview 1/component-roadmap evidence: [Node `node:wasi`](https://nodejs.org/api/wasi.html), [WebAssembly/WASI](https://github.com/WebAssembly/WASI), [WASI roadmap](https://wasi.dev/roadmap), and [Component Model documentation](https://component-model.bytecodealliance.org/)
