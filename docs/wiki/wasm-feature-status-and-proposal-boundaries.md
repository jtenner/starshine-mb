...
The current primary-source bridge is [`raw/wasm/2026-06-04-webassembly-proposal-status-current-recheck.md`](raw/wasm/2026-06-04-webassembly-proposal-status-current-recheck.md), which supplements the earlier same-day broad bridge [`raw/wasm/2026-06-04-webassembly-proposal-status-refresh.md`](raw/wasm/2026-06-04-webassembly-proposal-status-refresh.md). Together they rechecked the official WebAssembly Core 3.0 spec site, the official WebAssembly proposals repository, the finished-proposals table, the CG process phases document, the Relaxed Atomics proposal repository, and Starshine's local `GenValidProposalFeature` gate vocabulary. The recheck found one shared-routing update: `Relaxed Atomics` is now visible as an active Phase-2 proposal, and must stay separate from both finished/Core relaxed SIMD and Starshine's existing ordinary atomics support.
...
- Current status recheck: [`raw/wasm/2026-06-04-webassembly-proposal-status-current-recheck.md`](raw/wasm/2026-06-04-webassembly-proposal-status-current-recheck.md)
