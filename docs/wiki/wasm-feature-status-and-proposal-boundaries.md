...
| Custom descriptors and exact refs | Keep active proposal status visible and distinguish proposal struct metadata from Starshine-local broader type metadata. | See [`custom-descriptors/static-fixtures.md`](custom-descriptors/static-fixtures.md), [`custom-descriptors/ref-get-desc-fixture-path.md`](custom-descriptors/ref-get-desc-fixture-path.md), [`custom-descriptors/exact-reference-equivalence.md`](custom-descriptors/exact-reference-equivalence.md), and [`raw/wasm/2026-05-20-custom-descriptor-refgetdesc-exactness-refresh.md`](raw/wasm/2026-05-20-custom-descriptor-refgetdesc-exactness-refresh.md). |
