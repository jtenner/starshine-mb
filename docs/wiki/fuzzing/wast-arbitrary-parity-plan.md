...
1. Mirror already-valid generated instruction families where the parser supports the syntax: scalar numeric forms, GC refs/types, exception forms, memory/table bulk ops, descriptor reference test/cast forms, tail-call forms, SIMD text forms, and richer function/import/export/start declarations. Function/call/module text mirrors should stay aligned with [`../wast/function-call-and-module-authoring.md`](../wast/function-call-and-module-authoring.md). Ordinary non-tail `call_ref`, ordinary `ref.test`, ordinary `ref.cast`, and `br_on_*` remain blocked on WAST parser/printer widening; see [`../wast/function-call-and-module-authoring.md`](../wast/function-call-and-module-authoring.md) and [`../wast/reference-instruction-authoring.md`](../wast/reference-instruction-authoring.md).
