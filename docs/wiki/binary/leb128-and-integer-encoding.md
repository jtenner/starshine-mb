...
| --- | --- | --- | --- |
| Section payload length | `u32`-style unsigned LEB | [`decode_module_with_detail(...)`](../../../src/binary/decode.mbt), [`write_section(...)`](../../../src/binary/encode.mbt) | Corruptions here are covered by the invalid-binary `malformed-section-size-uleb` and `overwide-section-size-uleb` strategies. |
| Vector lengths | unsigned LEB | Binary `Decode` / `Encode` impls | Used for type vectors, imports, functions, locals, element/data payloads, and many name/custom maps. The invalid-binary lane now includes `malformed-custom-section-name-length-uleb`, `overwide-custom-section-name-length-uleb`, `malformed-name-subsection-size-uleb`, `overwide-name-subsection-size-uleb`, `malformed-name-section-func-name-count-uleb`, `overwide-name-section-func-name-count-uleb`, `malformed-name-section-local-name-count-uleb`, `overwide-name-section-local-name-count-uleb`, `malformed-name-section-type-name-count-uleb`, `overwide-name-section-type-name-count-uleb`, `malformed-name-section-table-name-count-uleb`, `overwide-name-section-table-name-count-uleb`, `malformed-name-section-memory-name-count-uleb`, `overwide-name-section-memory-name-count-uleb`, `malformed-name-section-global-name-count-uleb`, `overwide-name-section-global-name-count-uleb`, `malformed-name-section-elem-name-count-uleb`, and `overwide-name-section-elem-name-count-uleb` for custom/name-section length and name-map count carriers. |
| Indices | unsigned LEB | Section and instruction codecs | Includes `TypeIdx`, `FuncIdx`, `TableIdx`, `MemIdx`, `GlobalIdx`, `TagIdx`, `ElemIdx`, `DataIdx`, `LocalIdx`, and label depths. The invalid-binary lane now includes `malformed-local-index-uleb`, `malformed-local-set-index-uleb`, `malformed-local-tee-index-uleb`, `overwide-local-index-uleb`, `overwide-local-set-index-uleb`, `overwide-local-tee-index-uleb`, `malformed-global-index-uleb`, `malformed-global-set-index-uleb`, `overwide-global-index-uleb`, `overwide-global-set-index-uleb`, `malformed-call-func-index-uleb`, `malformed-return-call-func-index-uleb`, `malformed-ref-func-index-uleb`, `overwide-call-func-index-uleb`, `overwide-return-call-func-index-uleb`, `overwide-ref-func-index-uleb`, `malformed-call-indirect-type-index-uleb`, `malformed-call-indirect-table-index-uleb`, `malformed-return-call-indirect-type-index-uleb`, `malformed-return-call-indirect-table-index-uleb`, `malformed-call-ref-type-index-uleb`, `malformed-return-call-ref-type-index-uleb`, `overwide-call-indirect-type-index-uleb`, `overwide-call-indirect-table-index-uleb`, `overwide-return-call-indirect-type-index-uleb`, `overwide-return-call-indirect-table-index-uleb`, `overwide-call-ref-type-index-uleb`, `overwide-return-call-ref-type-index-uleb`, `malformed-throw-tag-index-uleb`, `malformed-try-table-catch-count-uleb`, `malformed-try-table-catch-tag-index-uleb`, `malformed-try-table-catch-label-index-uleb`, `overwide-throw-tag-index-uleb`, `overwide-try-table-catch-count-uleb`, `overwide-try-table-catch-tag-index-uleb`, `overwide-try-table-catch-label-index-uleb`, `malformed-struct-new-type-index-uleb`, `malformed-struct-get-field-index-uleb`, `malformed-array-new-data-type-index-uleb`, `malformed-array-new-data-index-uleb`, `overwide-struct-new-type-index-uleb`, `overwide-struct-get-field-index-uleb`, `overwide-array-new-data-type-index-uleb`, `overwide-array-new-data-index-uleb`, `malformed-array-new-elem-type-index-uleb`, `malformed-array-new-elem-elem-index-uleb`, `overwide-array-new-elem-type-index-uleb`, `overwide-array-new-elem-elem-index-uleb`, `malformed-br-label-index-uleb`, `malformed-br-if-label-index-uleb`, `malformed-br-table-target-count-uleb`, `malformed-br-table-target-label-index-uleb`, `malformed-br-table-default-label-index-uleb`, `overwide-br-label-index-uleb`, `overwide-br-if-label-index-uleb`, `overwide-br-table-target-count-uleb`, `overwide-br-table-target-label-index-uleb`, `overwide-br-table-default-label-index-uleb`, `malformed-table-index-uleb`, `malformed-table-set-index-uleb`, `malformed-table-size-index-uleb`, `malformed-table-grow-index-uleb`, `malformed-table-fill-index-uleb`, `overwide-table-index-uleb`, `overwide-table-set-index-uleb`, `overwide-table-size-index-uleb`, `overwide-table-grow-index-uleb`, `overwide-table-fill-index-uleb`, `malformed-memory-size-memory-index-uleb`, `malformed-memory-grow-memory-index-uleb`, `malformed-memory-fill-memory-index-uleb`, `overwide-memory-size-memory-index-uleb`, `overwide-memory-grow-memory-index-uleb`, `overwide-memory-fill-memory-index-uleb`, `malformed-memory-copy-dst-index-uleb`, `malformed-memory-copy-src-index-uleb`, `malformed-table-copy-dst-index-uleb`, `malformed-table-copy-src-index-uleb`, `overwide-memory-copy-dst-index-uleb`, `overwide-memory-copy-src-index-uleb`, `overwide-table-copy-dst-index-uleb`, `overwide-table-copy-src-index-uleb`, `malformed-data-index-uleb`, `overwide-data-index-uleb`, `malformed-memory-init-data-index-uleb`, `malformed-memory-init-memory-index-uleb`, `overwide-memory-init-data-index-uleb`, `overwide-memory-init-memory-index-uleb`, `malformed-elem-index-uleb`, `overwide-elem-index-uleb`, `malformed-table-init-elem-index-uleb`, `malformed-table-init-table-index-uleb`, `overwide-table-init-elem-index-uleb`, and `overwide-table-init-table-index-uleb` as instruction-immediate index/count carriers; `malformed-data-segment-memory-index-uleb`, `overwide-data-segment-memory-index-uleb`, `malformed-element-segment-table-index-uleb`, and `overwide-element-segment-table-index-uleb` as active segment descriptor resource-index carriers; `malformed-export-func-index-uleb`, `malformed-export-table-index-uleb`, `malformed-export-memory-index-uleb`, `malformed-export-global-index-uleb`, and `malformed-export-tag-index-uleb` as export descriptor index carriers; `malformed-function-section-type-index-uleb` and `overwide-function-section-type-index-uleb` as function-section type-index carriers; `malformed-import-func-type-index-uleb`, `overwide-import-func-type-index-uleb`, `malformed-import-tag-type-index-uleb`, and `overwide-import-tag-type-index-uleb` as import descriptor type-index carriers; plus `malformed-tag-type-index-uleb` and `overwide-tag-type-index-uleb` as section-entry index carriers; `malformed-select-type-count-uleb` and `overwide-select-type-count-uleb` cover typed-select immediate vector counts; `malformed-start-func-index-uleb`, `overwide-start-func-index-uleb`, `malformed-datacount-uleb`, and `overwide-datacount-uleb` cover singleton start/data-count section payload ULEBs; `malformed-data-segment-byte-count-uleb` and `overwide-data-segment-byte-count-uleb` cover data-segment byte-vector counts; `malformed-element-segment-func-index-uleb` and `overwide-element-segment-func-index-uleb` cover element-segment function-index payloads. |
| `i32.const` / `i64.const` | signed LEB | [`Decode for I32/I64`](../../../src/binary/decode.mbt), [`Encode for I32/I64`](../../../src/binary/encode.mbt) | Numeric rewrite passes must preserve value semantics and account for signed-LEB size when size is the goal. The invalid-binary lane now includes `malformed-i32-const-sleb`, `malformed-i64-const-sleb`, `overwide-i32-const-sleb`, and `overwide-i64-const-sleb` as signed instruction-immediate carriers. |
| Block type type indices | signed 33-bit LEB | [`Decode for S33`](../../../src/binary/decode.mbt), [`Encode for S33`](../../../src/binary/encode.mbt), [`Decode for BlockType`](../../../src/binary/decode.mbt) | Starshine decodes the nonnegative type-index subset into `TypeIdx`; value-type and void blocktypes are handled by their special byte forms first. The invalid-binary lane covers `malformed-blocktype-immediate`, `malformed-loop-blocktype-immediate`, `malformed-if-blocktype-immediate`, `invalid-blocktype-valtype-byte`, `overwide-blocktype-type-index-uleb`, `overwide-loop-blocktype-type-index-uleb`, and `overwide-if-blocktype-type-index-uleb`. |
| Ref heaptype immediates | signed 33-bit LEB | Heaptype/reference instruction codecs | The invalid-binary lane covers malformed and overwide heaptype immediates for `ref.null`, `ref.cast`, and `ref.test` with `malformed-ref-null-heaptype-immediate`, `malformed-ref-cast-heaptype-immediate`, `malformed-ref-test-heaptype-immediate`, `overwide-ref-null-heaptype-immediate`, `overwide-ref-cast-heaptype-immediate`, and `overwide-ref-test-heaptype-immediate`. |
| Prefixed instruction subopcodes | unsigned LEB | `0xFB`, `0xFC`, `0xFD`, and `0xFE` instruction decoders | The invalid-binary lane distinguishes reserved assigned subopcodes (`invalid-prefix-subopcode-byte`, `invalid-atomic-prefix-subopcode-byte`) from malformed and overwide subopcode ULEBs for supported prefixed spaces: `malformed-gc-prefix-subopcode-uleb`, `malformed-bulk-prefix-subopcode-uleb`, `malformed-simd-prefix-subopcode-uleb`, `malformed-atomic-prefix-subopcode-uleb`, `overwide-gc-prefix-subopcode-uleb`, `overwide-bulk-prefix-subopcode-uleb`, `overwide-simd-prefix-subopcode-uleb`, and `overwide-atomic-prefix-subopcode-uleb`. |
| Limits minimum/maximum sizes | unsigned LEB | Table and memory section/import descriptor codecs | The invalid-binary lane covers malformed and overwide memory/table minimum- and maximum-size fields with `malformed-memory-min-uleb`, `malformed-table-min-uleb`, `malformed-memory-max-uleb`, `malformed-table-max-uleb`, `overwide-memory-min-uleb`, `overwide-table-min-uleb`, `overwide-memory-max-uleb`, and `overwide-table-max-uleb`, plus the import-descriptor siblings `malformed-import-memory-min-uleb`, `malformed-import-table-min-uleb`, `malformed-import-memory-max-uleb`, `malformed-import-table-max-uleb`, `overwide-import-memory-min-uleb`, `overwide-import-table-min-uleb`, `overwide-import-memory-max-uleb`, and `overwide-import-table-max-uleb`; these stay separate from invalid limits flag bytes. |
...
A section payload length cannot run forever. The invalid-binary fuzzer's `malformed-section-size-uleb` strategy writes this kind of corrupt payload-size field in [`src/fuzz/invalid_binary.mbt`](../../../src/fuzz/invalid_binary.mbt), while section-payload strategies such as `malformed-start-func-index-uleb`, `overwide-start-func-index-uleb`, `malformed-datacount-uleb`, `overwide-datacount-uleb`, `malformed-code-body-size-uleb`, `overwide-code-body-size-uleb`, `malformed-code-local-decl-count-uleb`, `malformed-code-local-run-count-uleb`, `overwide-code-local-decl-count-uleb`, `overwide-code-local-run-count-uleb`, `malformed-type-section-count-uleb`, `malformed-code-section-count-uleb`, `malformed-import-section-count-uleb`, `malformed-export-section-count-uleb`, `malformed-table-section-count-uleb`, `malformed-memory-section-count-uleb`, `malformed-global-section-count-uleb`, `malformed-function-section-count-uleb`, `malformed-element-section-count-uleb`, `malformed-data-section-count-uleb`, `malformed-tag-section-count-uleb`, the matching `overwide-*-section-count-uleb` vector-count carriers, `malformed-functype-param-count-uleb`, `malformed-functype-result-count-uleb`, `overwide-functype-param-count-uleb`, `overwide-functype-result-count-uleb`, `malformed-data-segment-byte-count-uleb`, `malformed-element-segment-func-index-uleb`, `malformed-export-name-length-uleb`, `overwide-export-name-length-uleb`, `malformed-export-func-index-uleb`, `malformed-export-table-index-uleb`, `malformed-export-memory-index-uleb`, `malformed-export-global-index-uleb`, `malformed-export-tag-index-uleb`, `overwide-export-func-index-uleb`, `overwide-export-table-index-uleb`, `overwide-export-memory-index-uleb`, `overwide-export-global-index-uleb`, `overwide-export-tag-index-uleb`, `overwide-local-index-uleb`, `overwide-local-set-index-uleb`, `overwide-local-tee-index-uleb`, `overwide-global-index-uleb`, `overwide-global-set-index-uleb`, `overwide-call-func-index-uleb`, `overwide-return-call-func-index-uleb`, `overwide-ref-func-index-uleb`, `overwide-call-indirect-type-index-uleb`, `overwide-call-indirect-table-index-uleb`, `overwide-return-call-indirect-type-index-uleb`, `overwide-return-call-indirect-table-index-uleb`, `overwide-call-ref-type-index-uleb`, `overwide-return-call-ref-type-index-uleb`, `overwide-function-section-type-index-uleb`, `overwide-import-func-type-index-uleb`, `overwide-import-tag-type-index-uleb`, `overwide-tag-type-index-uleb`, `overwide-memory-min-uleb`, `overwide-table-min-uleb`, `overwide-memory-max-uleb`, `overwide-table-max-uleb`, `malformed-simd-load-memarg-align-uleb`, `malformed-simd-store-memarg-align-uleb`, `malformed-simd-load-memarg-offset-uleb`, `malformed-simd-store-memarg-offset-uleb`, `overwide-simd-load-memarg-align-uleb`, `overwide-simd-store-memarg-align-uleb`, `overwide-simd-load-memarg-offset-uleb`, `overwide-simd-store-memarg-offset-uleb`, `malformed-simd-load-lane-memarg-align-uleb`, `malformed-simd-store-lane-memarg-align-uleb`, `malformed-simd-load-lane-memarg-offset-uleb`, `malformed-simd-store-lane-memarg-offset-uleb`, `overwide-simd-load-lane-memarg-align-uleb`, `overwide-simd-store-lane-memarg-align-uleb`, `overwide-simd-load-lane-memarg-offset-uleb`, `overwide-simd-store-lane-memarg-offset-uleb`, `malformed-simd-load-splat-memarg-align-uleb`, `malformed-simd-load-splat-memarg-offset-uleb`, `overwide-simd-load-splat-memarg-align-uleb`, `overwide-simd-load-splat-memarg-offset-uleb`, `malformed-atomic-notify-memarg-align-uleb`, `malformed-atomic-notify-memarg-offset-uleb`, `overwide-atomic-notify-memarg-align-uleb`, `overwide-atomic-notify-memarg-offset-uleb`, `malformed-atomic-wait-memarg-align-uleb`, `malformed-atomic-wait-memarg-offset-uleb`, `overwide-atomic-wait-memarg-align-uleb`, `overwide-atomic-wait-memarg-offset-uleb`, `malformed-atomic-rmw-memarg-align-uleb`, `malformed-atomic-rmw-memarg-offset-uleb`, `overwide-atomic-rmw-memarg-align-uleb`, `overwide-atomic-rmw-memarg-offset-uleb`, `malformed-atomic-cmpxchg-memarg-align-uleb`, `malformed-atomic-cmpxchg-memarg-offset-uleb`, `overwide-atomic-cmpxchg-memarg-align-uleb`, `overwide-atomic-cmpxchg-memarg-offset-uleb`, `overwide-import-memory-min-uleb`, `overwide-import-table-min-uleb`, `overwide-import-memory-max-uleb`, `overwide-import-table-max-uleb`, `malformed-import-module-name-length-uleb`, `overwide-import-module-name-length-uleb`, `malformed-import-field-name-length-uleb`, `overwide-import-field-name-length-uleb`, `malformed-name-section-func-name-length-uleb`, `malformed-name-section-local-name-length-uleb`, `malformed-name-section-module-name-length-uleb`, `malformed-name-section-type-name-length-uleb`, `malformed-name-section-table-name-length-uleb`, `malformed-name-section-memory-name-length-uleb`, `malformed-name-section-global-name-length-uleb`, `malformed-name-section-elem-name-length-uleb`, `malformed-name-section-data-name-length-uleb`, `malformed-name-section-field-name-length-uleb`, `malformed-name-section-label-name-length-uleb`, `malformed-name-section-tag-name-length-uleb`, plus the matching `overwide-name-section-*-name-length-uleb` name-section string-length carriers keep the section size well-formed and corrupt an unsigned LEB inside the payload. The same invalid-binary matrix also covers generic section-frame shrinkage with `section-payload-length-underflow` and well-formed but too-small declared sizes with `type-section-size-underflow`, `function-section-size-underflow`, `import-section-size-underflow`, `export-section-size-underflow`, `table-section-size-underflow`, `memory-section-size-underflow`, `global-section-size-underflow`, `element-section-size-underflow`, `data-section-size-underflow`, `tag-section-size-underflow`, `start-section-size-underflow`, `datacount-section-size-underflow`, and `code-body-size-underflow`, which end the declared payload/body before the enclosed type, function type index, import/export descriptor, table or memory limit, global initializer, segment descriptor, tag type index, start function index, data segment count, or expression can be decoded. It also covers too-large but well-formed declared sizes with `type-section-size-overflow`, `code-section-size-overflow`, `function-section-size-overflow`, `import-section-size-overflow`, `export-section-size-overflow`, `table-section-size-overflow`, `memory-section-size-overflow`, `global-section-size-overflow`, `element-section-size-overflow`, `data-section-size-overflow`, `tag-section-size-overflow`, `start-section-size-overflow`, and `datacount-section-size-overflow`, where the payload frame extends beyond the bytes available for the section. Focused tests in [`src/fuzz/invalid_binary_wbtest.mbt`](../../../src/fuzz/invalid_binary_wbtest.mbt) expect decode-stage rejection for these malformed carriers.
