...
| Vector lengths | unsigned LEB | Binary `Decode` / `Encode` impls | Used for type vectors, imports, functions, locals, element/data payloads, and many name/custom maps. The invalid-binary lane now includes `malformed-custom-section-name-length-uleb`, `overwide-custom-section-name-length-uleb`, `malformed-name-subsection-size-uleb`, `overwide-name-subsection-size-uleb`, `malformed-name-section-func-name-count-uleb`, `overwide-name-section-func-name-count-uleb`, `malformed-name-section-local-name-count-uleb`, `overwide-name-section-local-name-count-uleb`, `malformed-name-section-type-name-count-uleb`, `overwide-name-section-type-name-count-uleb`, `malformed-name-section-table-name-count-uleb`, `overwide-name-section-table-name-count-uleb`, `malformed-name-section-memory-name-count-uleb`, and `overwide-name-section-memory-name-count-uleb` for custom/name-section length and name-map count carriers. |
