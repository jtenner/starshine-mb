...
A section payload length cannot run forever. The invalid-binary fuzzer's `malformed-section-size-uleb` strategy writes this kind of corrupt payload-size field in [`src/fuzz/invalid_binary.mbt`](../../../src/fuzz/invalid_binary.mbt), while section-payload strategies such as `malformed-start-func-index-uleb`, `malformed-datacount-uleb`, `malformed-code-body-size-uleb`, `malformed-code-local-decl-count-uleb`, `malformed-code-local-run-count-uleb`, `overwide-code-local-decl-count-uleb`, `overwide-code-local-run-count-uleb`, `malformed-functype-param-count-uleb`, `malformed-functype-result-count-uleb`, `overwide-functype-param-count-uleb`, `overwide-functype-result-count-uleb`, `malformed-data-segment-byte-count-uleb`, `malformed-element-segment-func-index-uleb`, `malformed-export-name-length-uleb`, `overwide-export-name-length-uleb`, `malformed-export-func-index-uleb`, `malformed-export-table-index-uleb`, `malformed-export-memory-index-uleb`, `malformed-export-global-index-uleb`, `malformed-export-tag-index-uleb`, `overwide-export-func-index-uleb`, `overwide-export-table-index-uleb`, `overwide-export-memory-index-uleb`, `overwide-export-global-index-uleb`, `overwide-export-tag-index-uleb`, `overwide-function-section-type-index-uleb`, `overwide-import-func-type-index-uleb`, `overwide-import-tag-type-index-uleb`, `overwide-tag-type-index-uleb`, `malformed-import-module-name-length-uleb`, `overwide-import-module-name-length-uleb`, `malformed-import-field-name-length-uleb`, `overwide-import-field-name-length-uleb`, `malformed-name-section-func-name-length-uleb`, `malformed-name-section-local-name-length-uleb`, `malformed-name-section-module-name-length-uleb`, `malformed-name-section-type-name-length-uleb`, `malformed-name-section-table-name-length-uleb`, `malformed-name-section-memory-name-length-uleb`, `malformed-name-section-global-name-length-uleb`, `malformed-name-section-elem-name-length-uleb`, `malformed-name-section-data-name-length-uleb`, `malformed-name-section-field-name-length-uleb`, `malformed-name-section-label-name-length-uleb`, `malformed-name-section-tag-name-length-uleb`, plus the matching `overwide-name-section-*-name-length-uleb` name-section string-length carriers keep the section size well-formed and corrupt an unsigned LEB inside the payload. The same invalid-binary matrix also covers well-formed but too-small declared sizes with `type-section-size-underflow`, `function-section-size-underflow`, `import-section-size-underflow`, `export-section-size-underflow`, `table-section-size-underflow`, `memory-section-size-underflow`, `global-section-size-underflow`, `element-section-size-underflow`, `data-section-size-underflow`, `tag-section-size-underflow`, `start-section-size-underflow`, `datacount-section-size-underflow`, and `code-body-size-underflow`, which end the declared payload/body before the enclosed type, function type index, import/export descriptor, table or memory limit, global initializer, segment descriptor, tag type index, start function index, data segment count, or expression can be decoded. It also covers too-large but well-formed declared sizes with `type-section-size-overflow`, `code-section-size-overflow`, `function-section-size-overflow`, `import-section-size-overflow`, `export-section-size-overflow`, `table-section-size-overflow`, `memory-section-size-overflow`, `global-section-size-overflow`, `element-section-size-overflow`, `data-section-size-overflow`, `tag-section-size-overflow`, `start-section-size-overflow`, and `datacount-section-size-overflow`, where the payload frame extends beyond the bytes available for the section. Focused tests in [`src/fuzz/invalid_binary_wbtest.mbt`](../../../src/fuzz/invalid_binary_wbtest.mbt) expect decode-stage rejection for these malformed carriers.
