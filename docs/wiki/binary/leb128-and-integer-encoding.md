...
| Prefixed instruction subopcodes | unsigned LEB | `0xFB`, `0xFC`, and `0xFD` instruction decoders | The invalid-binary lane distinguishes an assigned-but-invalid subopcode (`invalid-prefix-subopcode-byte`) from malformed subopcode ULEBs for supported prefixed spaces: `malformed-gc-prefix-subopcode-uleb`, `malformed-bulk-prefix-subopcode-uleb`, and `malformed-simd-prefix-subopcode-uleb`. |
