...
The standardized name section is a special custom section named `name`, but the official-versus-local boundary matters. The current 2026-06-04 primary-source refresh in [`../raw/wasm/2026-06-04-custom-name-annotation-current-refresh.md`](../raw/wasm/2026-06-04-custom-name-annotation-current-refresh.md) establishes that the current WebAssembly 3.0 page documents module, function, local, type, field, and tag name subsections. The 2026-06-05 Extended Name Section bridge in [`../raw/wasm/2026-06-05-extended-name-section-boundary-refresh.md`](../raw/wasm/2026-06-05-extended-name-section-boundary-refresh.md) sharpens the remaining ids: Starshine additionally accepts, validates, and can emit label, table, memory, global, element, and data name maps as proposal-facing/local richer metadata, not current Core 3.0 name-section evidence. Use [`../wasm-extended-name-section-boundary.md`](../wasm-extended-name-section-boundary.md) for that active Phase-2 proposal boundary.
