...
The current element-segment refresh in [`../raw/wasm/2026-06-04-element-segment-current-refresh.md`](../raw/wasm/2026-06-04-element-segment-current-refresh.md) confirms the official active/passive/declarative mode split, section-id/header matrix, typed declarative text breadth, and the historical WAST declarative-mode gap, superseded for function lists by the September 10 fix. The current data/data-count refresh in [`../raw/wasm/2026-06-04-data-segment-datacount-current-refresh.md`](../raw/wasm/2026-06-04-data-segment-datacount-current-refresh.md) rechecks the official data segment text/binary shapes; the focused data-count recheck [`../raw/wasm/2026-06-04-data-count-code-data-index-recheck.md`](../raw/wasm/2026-06-04-data-count-code-data-index-recheck.md) plus [`../validate/data-count-and-code-data-indices.md`](../validate/data-count-and-code-data-indices.md) own the broader any-code-data-index requirement. The focused validator page [`../validate/resource-sections-and-limits.md`](../validate/resource-sections-and-limits.md) owns the active-segment offset type checks, element/table type matching, data-count equality versus body-requirement split, and invalid-fuzzer family mapping. Starshine mirrors those concepts in [`ElemMode`](../../../src/lib/types.mbt), [`ElemKind`](../../../src/lib/types.mbt), [`DataMode`](../../../src/lib/types.mbt), `ElemSec`, `DataCntSec`, and `DataSec`.
