...
- `ref.func` declaration correction: [`../raw/wasm/2026-07-10-ref-func-start-refs-source-correction.md`](../raw/wasm/2026-07-10-ref-func-start-refs-source-correction.md); standards and local `call_ref` routing: [`../wasm-typed-function-references-boundary.md`](../wasm-typed-function-references-boundary.md)
