...
2. If the change affects binary bytes or opcode coverage, add binary roundtrip coverage in [`src/binary/tests_wbtest.mbt`](../../../src/binary/tests_wbtest.mbt) and keep [`../binary/instruction-and-expression-encoding.md`](../binary/instruction-and-expression-encoding.md) aligned.
