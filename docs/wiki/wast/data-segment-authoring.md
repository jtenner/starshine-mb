...
The current evidence is the official WebAssembly 3.0 text, syntax, binary, module-validation, and instruction-validation pages, now dated 2026-07-10, together with Starshine's WAST parser, lowerer, printer, core model, binary codec, validator, generator, and WAST arbitrary surfaces. The active-proposal routing for numeric data payload syntax is the [proposal overview](https://github.com/WebAssembly/wat-numeric-values/blob/main/proposals/wat-numeric-values/Overview.md).
...
- Active numeric data-payload proposal routing: <https://github.com/WebAssembly/wat-numeric-values/blob/main/proposals/wat-numeric-values/Overview.md>
