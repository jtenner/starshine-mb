...
The current primary-source and local-code manifest is [`../raw/wasm/2026-05-19-wast-call-and-function-sources.md`](../raw/wasm/2026-05-19-wast-call-and-function-sources.md). It narrows the WAST authoring side of the broader function-section snapshot in [`../raw/wasm/2026-05-13-function-import-export-section-sources.md`](../raw/wasm/2026-05-13-function-import-export-section-sources.md).
...
Starshine's core model and valid generator know about ordinary `call_ref`, and [`src/validate/typecheck.mbt`](../../../src/validate/typecheck.mbt) typechecks it. Current WAST text does not register a `call_ref` keyword, so WAST authors should not write direct text fixtures for ordinary `call_ref` until parser/lowerer/printer support exists. Use core/binary/generator fixtures for that surface, or use `return_call_ref` only when the test is specifically about tail-call semantics.
...
- **Keep direct calls separate from first-class function references.** `call $f` does not require `$f` to be in the `ref.func` declaration set; `ref.func $f` does.
...
- Focused primary-source snapshot: [`../raw/wasm/2026-05-19-wast-call-and-function-sources.md`](../raw/wasm/2026-05-19-wast-call-and-function-sources.md)
...
- Core and validation: [`../../../src/lib/types.mbt`](../../../src/lib/types.mbt), [`../../../src/validate/typecheck.mbt`](../../../src/validate/typecheck.mbt), [`../../../src/validate/validate.mbt`](../../../src/validate/validate.mbt)
