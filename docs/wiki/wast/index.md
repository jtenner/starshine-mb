...
- [`data-segment-authoring.md`](data-segment-authoring.md) — active/passive `(data ...)`, offsets, string payloads, conservative emitted `DataCntSec`, data-index user rewrite guidance, and routing to the focused validator data-count requirement page.
