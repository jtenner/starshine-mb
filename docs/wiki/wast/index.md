...
- [`data-segment-authoring.md`](data-segment-authoring.md) — active/passive `(data ...)`, offsets, string payloads, conservative emitted `DataCntSec`, current data-count requirement split for bulk-memory versus data-backed GC array users, and pass guidance for data-index users.
