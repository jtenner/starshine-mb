...
- [`exception-tag-authoring.md`](exception-tag-authoring.md) — finished/Core-3.0 Exception Handling routing for tag declarations and exception instructions, including `throw_ref` nullable operands, catch payloads, the current resultful-tag validation split, and boundaries against Stack Switching / JSPI / Relaxed Dead Code Validation.
