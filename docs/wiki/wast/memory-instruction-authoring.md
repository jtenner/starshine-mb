...
The current source set combines the Core multi-memory, data/data-count, and address-width refreshes with Starshine WAST parser/lowerer/printer, core instruction, binary codec, validator, generator, arbitrary WAST, and HOT-IR effect surfaces. The 2026-06-05 Multi-Memory bridge [`../raw/wasm/2026-06-05-multi-memory-core-boundary-refresh.md`](../raw/wasm/2026-06-05-multi-memory-core-boundary-refresh.md) adds the focused selected-memory/status route for `MemIdx` and `MemArg` carriers; the living page is [`../wasm-multi-memory-boundary.md`](../wasm-multi-memory-boundary.md). The 2026-06-05 Custom Page Sizes bridge [`../raw/wasm/2026-06-05-custom-page-sizes-boundary-refresh.md`](../raw/wasm/2026-06-05-custom-page-sizes-boundary-refresh.md) adds a no-support boundary for proposal memories whose page size is not represented locally. The 2026-06-05 Memory Control bridge [`../raw/wasm/2026-06-05-memory-control-boundary-refresh.md`](../raw/wasm/2026-06-05-memory-control-boundary-refresh.md) adds a no-support boundary for discard/commit/protection/mapping-style runtime memory-management proposal surfaces. The targeted 2026-05-20 refresh in [`../raw/wasm/2026-05-20-memory64-bulk-memory-validation-refresh.md`](../raw/wasm/2026-05-20-memory64-bulk-memory-validation-refresh.md) rechecked the memory64 bulk-memory operand matrix; the 2026-06-04 refresh in [`../raw/wasm/2026-06-04-memory-table-address-width-validation-refresh.md`](../raw/wasm/2026-06-04-memory-table-address-width-validation-refresh.md) confirms the official Core 3.0 pages dated 2026-06-03 still use the same positional address-width rules and anchors the current Starshine code-map caveats.
