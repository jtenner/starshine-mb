...
_Date:_ 2026-06-21
_Status:_ completed first `[O4Z-AUDIT-OI-M]` implementation sub-slice; superseded by later 2026-07-02 OI-M follow-ups for effect/trap-preserving sibling localization and direct one-use arity-2-through-12 selected-child localization.
...
- direct selected tuple children with exactly two, three, four, five, six, seven, eight, nine, ten, eleven, twelve, or thirteen scalar results are now localized by storing selected-child results to scratch locals in stack-pop order and reloading the requested lane;
- unsupported control/branch/EH/nested-region lanes, selected-child arities 14+, multi-result non-selected siblings, multi-use tuple producers, and generalized tuple-scratch reconstruction remain open OI-M work.
