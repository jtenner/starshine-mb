...
_Date:_ 2026-06-21
_Status:_ completed first `[O4Z-AUDIT-OI-M]` implementation sub-slice; superseded by later 2026-07-02/2026-07-03 OI-M follow-ups for effect/trap-preserving sibling localization and generalized direct one-use selected-child localization.

## 2026-07-02 follow-up notes

Later slices extended the original direct one-use subset without closing OI-M broadly:
...
- direct selected tuple children with arbitrary positive scalar result arity are now localized by storing selected-child results to scratch locals in stack-pop order and reloading the requested lane; the generalized source audit and test helper landed in `docs/wiki/raw/research/1416-2026-07-03-optimize-instructions-oi-m-generalized-selected-child-localization.md`;
- unsupported control/branch/EH/nested-region lanes, multi-result non-selected siblings, multi-use tuple producers, and generalized tuple-scratch reconstruction remain open OI-M work.
