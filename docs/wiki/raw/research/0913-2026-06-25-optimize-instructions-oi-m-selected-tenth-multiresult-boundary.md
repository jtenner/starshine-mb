...
It remains useful as source-backed history and as a reminder that arity 15+ and generalized tuple-scratch reconstruction are still outside the implemented subset after the later arity-14 slice.
