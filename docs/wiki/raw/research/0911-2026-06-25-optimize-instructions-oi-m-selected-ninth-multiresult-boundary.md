...
This note is retained as source/probe history. It no longer defines an active boundary for direct one-use arity-9 selected children; after the later arity-11 slice, arity 12+ remains the next selected-child tuple-scratch boundary.
