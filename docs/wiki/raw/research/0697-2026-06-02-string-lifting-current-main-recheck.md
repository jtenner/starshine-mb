...
sources:
  - ../binaryen/2026-06-02-string-lifting-current-main-recheck.md
  ...
  - ./0457-2026-05-05-string-lifting-current-main-recheck.md
...
The `string-lifting` dossier already had a stable source contract, but the freshness layer needed a new current-main recheck so the living pages could stay honest about upstream drift.
...
The 2026-06-02 recheck reused the same reasoning frame as the 2026-05-05 freshness note and the earlier 2026-04-26 port-readiness and 2026-04-25 signature-correction notes.
...
- Refreshed the `string-lifting` overview, Binaryen strategy, implementation/test-map, shape catalog, Starshine status page, and Starshine readiness bridge to cite this 2026-06-02 freshness layer.
