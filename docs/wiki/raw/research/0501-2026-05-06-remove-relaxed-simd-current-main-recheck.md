# Research 0501: 2026-05-06 remove-relaxed-simd current-main recheck

## Question

Does Binaryen `remove-relaxed-simd` still match the documented dossier contract on current `main`, and do the Starshine pages need any behavioral correction?

## Source base

- [`../binaryen/2026-05-06-remove-relaxed-simd-current-main-recheck.md`](../binaryen/2026-05-06-remove-relaxed-simd-current-main-recheck.md)
...
I refreshed the pass pages with a 2026-05-06 current-main recheck note, while keeping the behavior claims unchanged.
