# 0512 - 2026-05-06 - de-nan current-main line-anchor refresh

## Question

Does current Binaryen `main` still teach the same `de-nan` / `denan` contract after a 2026-05-06 source-anchor refresh?

## Answer

Yes. No teaching-relevant drift was found.

The reviewed current-main surface still matches the existing oracle on the important parts of the pass:

- `denan` remains NaN-to-zero instrumentation, not an optimizer
...
The right update is freshness stamping plus source-bridge indexing, not a contract correction.

## Raw source note

- [`../../binaryen/2026-05-06-de-nan-current-main-line-anchor-refresh.md`](../../binaryen/2026-05-06-de-nan-current-main-line-anchor-refresh.md)
