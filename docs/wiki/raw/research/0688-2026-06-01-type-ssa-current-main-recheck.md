# 0688 - `type-ssa` current-main recheck and freshness-layer refresh
...
The `type-ssa` dossier was already source-correct, but its freshness layer was still pinned to the 2026-05-06 current-main recheck.
This follow-up records a 2026-06-01 current-main recheck so the living pages can carry a fresher provenance layer and keep the stale created-type propagation interpretation retired.
...
- `docs/wiki/raw/binaryen/2026-06-01-type-ssa-current-main-recheck.md`
