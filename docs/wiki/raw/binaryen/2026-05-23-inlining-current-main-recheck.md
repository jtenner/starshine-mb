...
_Date captured:_ 2026-05-23
_Status:_ immutable current-main drift check for the `docs/wiki/binaryen/passes/inlining/` dossier

## Scope

This note records a narrow current-main recheck after the earlier tagged `version_129` primary-source capture and the 2026-04-26 port-readiness bridge.
