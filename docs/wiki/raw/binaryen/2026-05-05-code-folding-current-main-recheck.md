...
This file records the primary online sources rechecked for the 2026-05-05 `code-folding` wiki-health pass.
It extends, rather than replaces, the earlier tagged-source manifest in `docs/wiki/raw/binaryen/2026-04-22-code-folding-primary-sources.md` and the earlier current-main bridge in `docs/wiki/raw/binaryen/2026-04-25-code-folding-current-main-recheck.md`.
...
- No teaching-relevant drift was found in this focused recheck. The useful 2026-05-05 wiki change is therefore an implementation/test-map page and fresher source bridge, not a semantic rewrite of the existing strategy pages.
