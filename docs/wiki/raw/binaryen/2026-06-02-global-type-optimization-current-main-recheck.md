...
This file records the 2026-06-02 current-main spot check for `global-type-optimization`.
...
### Source facts observed on 2026-06-02
...
- `gto_and_cfp_in_O.wast` still teaches the same closed-world-only scheduler interaction: `-O` plus `--closed-world` runs `gto`, then lets later cleanup and CFP exploit the removed field.

## Durable conclusion

The 2026-06-02 recheck did not surface teaching-relevant drift from the existing `version_129` story.
