...
This file captures the focused primary online sources checked on 2026-05-05 to refresh the existing `directize` dossier.
The dossier already had a `version_129` source manifest; this bridge answers the narrower maintenance question:

- has current Binaryen `main` changed the teaching-important `directize` contract since the 2026-04-25 source bridge?
...
The current `main` surfaces checked on 2026-05-05 still support the same durable contract taught from `version_129`:
