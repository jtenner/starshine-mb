...
It follows the 2026-04-26 source-correction manifest and the 2026-05-06 freshness recheck and asks whether current `main` still matches the allocation-subtype teaching story.

The answer on the reviewed surfaces is still yes.
