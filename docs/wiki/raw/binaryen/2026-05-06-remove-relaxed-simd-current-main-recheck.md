...
This file captures a narrow primary-source recheck of Binaryen `remove-relaxed-simd` after the 2026-05-05 dossier freshness update. It is intentionally a source manifest and drift note, not the main teaching document.
...
The 2026-05-06 recheck found **no teaching-relevant current-main drift** for `remove-relaxed-simd` beyond the existing 2026-04-25 correction, 2026-04-26 port-readiness note, and 2026-05-05 freshness layer.
