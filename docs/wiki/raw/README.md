...
- Topic raw-source directories such as `raw/binaryen/`, `raw/fuzzing/`, `raw/ir2/`, `raw/moonbit/`, `raw/node/`, `raw/release/`, `raw/validation/`, and `raw/wasm/` hold durable primary-source manifests or source snapshots grouped by source family.
