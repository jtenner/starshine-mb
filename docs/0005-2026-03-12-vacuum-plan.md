...
- `docs/0002-2026-03-11-differences.md`
...
This matches the note in `docs/0002-2026-03-11-differences.md` that the current runner skip only helps repeated no-op `Vacuum` invocations, not the first pathological one.
...
Also collect top-N slow functions, following the tracing guidance in `docs/0001-2026-03-10-tracing.md`.
